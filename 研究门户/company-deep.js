const COMPANY_DEEP_DATA = {
  ...
  luxshare: {
    ...
    latest: {
      ...
      happened: "收入和利润继续增长，但经营现金流净额明显转负。",
      businessImpact: "长期逻辑没坏，但质量跟踪权重已经明显上调，研究重点转向扩张质量验证。",
      valuationImpact: "资金动作转向克制，优先等待下一次财报验证，不再因为短期增长而加大动作。",
      ...
      timeline: [
        "2025Q1：经营现金流显著转负，成为最重要的新风险信号。",
        "2024 全年：收入和利润仍保持双位数增长。",
        "持续：汽车和通信业务扩张是长期逻辑的重要延展方向。",
      ],
    },
    archive: {
      title: "完整版档案",
