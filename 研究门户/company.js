const COMPANY_DATA = {
  nvidia: {
    ...
    tag: "美股",
    tagClass: "us",
    summary: "这是 AI 基础设施主线最核心的公司之一。现在真正要看的不是“GPU 还强不强”，而是 NVIDIA 能否把算力、网络、协议、软件运行时、云平台和企业智能体需求连成一套 AI 工厂标准。",
    thesis: "NVIDIA 已经从 GPU 龙头进入 AI 工厂平台阶段：Data Center 现金流是主体，网络与系统协同抬高护城河，推理/企业 agent/物理 AI 决定下一段增长能否接棒。",
    action: "维持 A 池核心，并适度提升研究优先级",
    portfolioAction: "继续观察，不追价；若下一次财报继续验证数据中心收入、毛利率、Networking 采用和推理需求，可重新评估更积极分批。",
    nextCheck: "下一次 FY27 Q1 财报：收入是否兑现 780 亿美元指引，毛利率是否维持约 75%，Networking / Spectrum-X 是否更可见，云厂商 capex 和推理需求是否继续支撑 AI 工厂扩张。",
    positioning: "NVIDIA 已经不只是做 GPU 的芯片公司。更准确地说，它在试图成为 AI 工厂的系统平台：训练和推理用 GPU，集群扩展用 NVLink / Spectrum-X / SuperNIC，软件生态用 CUDA / NeMo / OpenShell，客户部署通过云厂商、模型公司、企业软件平台和主权 AI 项目扩散。",
    products: "核心产品已经形成三层：底层是数据中心 GPU、CPU、SuperNIC、交换机和整机系统；中间是 CUDA、NVLink、Spectrum-X、MRC、NIM / NeMo 等软件和协议能力；上层是 AI factories、企业 agent 运行环境、物理 AI 和云端平台合作。真正的价值不是单卡参数，而是这些层能否共同提高客户 GPU 利用率和部署效率。",
    markets: "主要客户包括 Microsoft、Google Cloud、Oracle、OpenAI、Meta 等超大云/模型客户，国家实验室和主权 AI 项目，以及 SAP、ServiceNow 这类企业软件入口。短期收入仍由数据中心资本开支主导，下一阶段要看推理、企业 agent、物理 AI 和国家级 AI 基础设施是否把需求曲线拉长。",
    moatDetail: "护城河强在系统协同而不是单点参数：CUDA 和开发者生态降低替换意愿，NVLink / Spectrum-X / MRC 提高大集群效率，云厂商和模型公司多年路线图带来客户绑定，软件运行时和企业 agent 入口把 NVIDIA 从硬件层向应用层延伸。弱点也清楚：客户 capex、自研 ASIC、出口规则和供应链节奏任何一个转弱，都会放大估值波动。",
    business: "核心业务已经从 GPU 芯片，扩展为数据中心算力、网络、协议、软件、整机平台和 AI 工厂方案的系统协同。",
    ...
    latestEvent: "Google Cloud、Spectrum-X / MRC、SAP / ServiceNow 和国家级 AI 超算事件共同强化 NVIDIA 的 AI 工厂平台逻辑。",
    businessImpact: "这些事件不是同一类新闻：Google Cloud 验证云端 AI 工厂打包能力，Spectrum-X / MRC 验证网络和协议层控制点，SAP / ServiceNow 验证企业 agent 运行时入口，DOE / Argonne 验证国家级 AI 科学基础设施需求。合在一起看，NVIDIA 的边界正在从“卖 GPU”扩展到“定义 AI 基础设施系统”。",
    valuationImpact: "研究上继续维持核心并提高平台化权重；但当前价格已经对强增长给出高预期，动作上仍要等 FY27 Q1 验证收入、毛利率、Networking、推理需求和客户 capex，而不是因为合作新闻单独追价。",
    risk: "超大客户资本开支放缓、自研 ASIC 替代、出口限制和平台化扩张带来的盈利质量波动。",
    focus: [
      "下一次 FY27 Q1 财报里数据中心收入和毛利率",
      "Spectrum-X、MRC、SuperNIC、Networking 收入和客户采用是否继续增强",
      "Google Cloud、OpenAI、Microsoft、Oracle 等客户是否把 NVIDIA 平台能力转化成持续 capex",
      "推理、企业 agent、物理 AI 和主权 AI 是否真正接棒训练需求",
      "平台化能力是否继续增强，而不是停留在芯片发布和合作叙事层",
    ],
    trackingGuide: [
      "先看哪里：优先看季度财报和业绩会。重点核对数据中心收入、毛利率、库存和管理层对客户 capex 的表述。",
      "怎么判断：如果数据中心收入高增长同时毛利率稳住，说明平台化红利还在；如果收入还强但毛利率和库存恶化，就要警惕质量下降。",
      "再看外部：跟踪 Meta、Microsoft、Google Cloud、OpenAI、Oracle、Amazon 等大客户 capex 指引，以及 Rubin、NVLink、Spectrum-X、MRC、光互连、企业 agent 和物理 AI 相关发布，看平台能力是不是继续扩大。",
    ],
    financeMap: {
    ...
    businessMap: {
      intro: "NVIDIA 现在不应只被理解为 GPU 芯片公司。更准确的理解是：它用 GPU、CPU、SuperNIC、Spectrum-X 网络、NVLink、整机系统、CUDA 软件生态和 AI 工厂方案，把自己放在全球 AI 基础设施资本开支的核心位置。看它要按四层拆：数据中心现金流、网络和系统控制点、云端/主权 AI 平台化、企业 agent 与物理 AI 的长期期权。",
      segments: [
        {
        ...
        {
          title: "云端与主权 AI：需求来源扩散",
          scale: "Google Cloud A5X、OpenAI / Microsoft / Oracle、DOE / Argonne 国家级 AI 超算",
          text: "云厂商合作说明 NVIDIA 不只是把芯片卖给 hyperscaler，而是在和云平台共同定义训练、推理、机密计算、模型工具链和物理 AI 开发环境。国家级 AI 超算则说明需求可能从互联网客户扩展到政府、科研、能源和主权 AI 场景。",
        },
        {
          title: "企业智能体与推理：下一阶段需求入口",
          scale: "SAP / ServiceNow、OpenShell、安全运行时、RTX / DGX Spark 本地 agent",
          text: "如果企业智能体从演示走向真实工作流，长期运行、多步骤执行和治理要求会带来持续推理需求。NVIDIA 通过 OpenShell、模型、domain-specific skills、RTX PC 和 DGX Spark 试图把 agent 从云端训练延伸到企业执行层和本地运行环境。",
        },
      ],
      moat: [
        {
          title: "强在哪里",
          text: "强在 CUDA 生态、硬件迭代、系统级交付、网络互连、协议控制、客户绑定和开发者迁移成本。竞争对手即使单点芯片追近，也很难同时复制 GPU、网络、软件栈、客户路线图和生产级部署经验。",
        },
        {
          title: "和普通芯片公司差别",
        ...
        {
          title: "护城河的弱点",
          text: "高度依赖超大客户 capex、先进制程供应链和出口规则。如果客户自研 ASIC、网络方案替代、Rubin 量产节奏不顺或 capex 放缓，市场会快速重估高估值里的平台溢价。",
        },
      ],
    },
    valuationFrame: {
    ...
    valuationModel: {
      ...
      actionPolicy: {
        fundamentalState: "平台化证据继续增强，但价格已经要求 FY27 Q1 继续强兑现",
        low: "价格低于保守区间时，先复核是否出现客户 capex、出口限制、毛利率或供应链恶化；若没有恶化，可提高研究和分批复核优先级。",
        belowMid: "价格低于中枢时，可以复核机会，但必须确认 Data Center 增长、毛利率、Networking 采用和客户 capex 仍支撑原估值区间。",
        nearMid: "价格接近中枢时，以继续观察为主，等待下一季收入、毛利率、Rubin / Blackwell 供给和推理需求验证。",
        nearHigh: "价格接近上沿时，不因合作新闻追价；只有财报继续证明平台化正在变成收入和现金流，才考虑更积极动作。",
        expensive: "价格高于乐观区间时，控制追价。除非 FY27 Q1 明显超预期且管理层上修 Data Center、Networking、推理或客户 capex 口径，否则等待更安全的位置。",
      },
      priceRange: {
        symbol: "NVDA",
        currency: "USD",
  ...
  alibaba: {
    ...
    thesis: "阿里的核心矛盾已经从“电商是否稳定”转为“老现金流能否托住新投入，云 AI 能否把估值中枢抬起来”。",
    action: "维持 A 池核心，但研究重点从平台折价修复转向云 AI 回报率和自由现金流恢复",
    portfolioAction: "继续观察；只有云 AI 增长、即时零售亏损收窄、自由现金流修复和回购执行同时改善时，才进入更积极分批候选。",
    nextCheck: "下一次重点看四件事：Cloud Intelligence 收入和 EBITA、AI 产品收入质量、即时零售亏损变化、自由现金流与回购是否重新形成正循环。",
    ...
    financials: "当前财报不应只看收入，而要看一条链：云 AI 是否贡献增量、即时零售消耗多少利润、自由现金流能否恢复、回购能否继续提高每股价值。",
    valuation: "阿里的估值修复不是单靠便宜，而是靠“云 AI 上修中枢 + 电商现金流托底 + 回购提高每股价值”三件事同时成立。",
    ...
    financeMap: {
      intro: "阿里的财务地图要顺着一条因果链看：第一，云和 AI 是否真的带来新增长；第二，即时零售和技术投入吃掉了多少利润；第三，自由现金流能否恢复；第四，回购能否把现金流转成每股价值。",
      rows: [
        {
          metric: "集团收入",
          value: "2848.43 亿元",
          change: "同比 +2%；剔除已处置业务后 +9%",
          read: "总收入不是核心答案。阿里的关键不是集团增速是否漂亮，而是增量是否来自云 AI，存量现金流是否仍能支撑投入。",
        },
        {
          metric: "Cloud Intelligence 收入",
          value: "432.84 亿元",
          change: "同比 +36%",
          read: "这是估值中枢能否上移的第一证据。云如果持续 30%+ 增长，阿里就不只是传统平台折价修复。",
        },
        {
          metric: "云分部 adjusted EBITA",
          value: "39.11 亿元",
          change: "同比 +25%",
          read: "这是第二证据：云不能只增长不赚钱。收入高增同时 EBITA 改善，才说明 AI 云不是烧钱叙事。",
        },
        {
          metric: "AI 相关产品收入",
        ...
        },
        {
          ...
          value: "346.13 亿元",
          change: "同比 -43%",
          read: "这是当前最大压力。即时零售和用户体验投入正在消耗老现金流，决定阿里能不能安全穿过再投入周期。",
        },
        {
        ...
        },
        {
          ...
          change: "同比 -49% / -71%",
          read: "这是估值修复的闸门。云 AI 再强，如果自由现金流持续下滑，市场也只会给折扣而不是重估。",
        },
        {
          metric: "现金及其他流动投资",
          value: "5601.75 亿元",
      ...
      bridge: [
        {
          ...
          text: "集团收入 2848.43 亿元，同比增长 2%，同口径增长 9%；这只能说明阿里没有失速，不能证明估值中枢上移。",
        },
        {
          label: "第二层：云和 AI 是第二增长曲线",
          text: "云收入增长 36%，AI 产品连续十个季度三位数增长，这是阿里从“平台现金流资产”走向“云 AI 复合资产”的核心证据。",
        },
        {
        ...
        },
        {
          ...
          text: "中国电商 adjusted EBITA 同比下降 43%，集团 adjusted EBITA 同比下降 57%，说明新投入正在真实消耗老业务利润。",
        },
        {
          label: "第五层：现金流决定估值修复质量",
          text: "自由现金流同比下降 71%。如果后续不能恢复，云 AI 只能提高想象空间，不能真正提高估值容错率。",
        },
      ],
      notes: [
        {
          title: "当前结论",
          text: "阿里的云和 AI 逻辑明显强化，但当前不是单纯利好。它正在用核心电商现金流和资产负债表支持新一轮投入，后续必须验证投入回报。",
        },
        {
          title: "下一季最该看",
        ...
        {
          title: "真正的风险信号",
          text: "如果云 AI 高增长不能带来利润，且即时零售继续拖累电商 EBITA 与自由现金流，阿里会继续被市场当作“便宜但有折扣”的资产。",
        },
      ],
    },
    businessMap: {
      intro: "阿里不是单纯电商公司，也不是单纯 AI 公司。更准确的理解是：电商提供现金流和场景，云提供算力与企业入口，Qwen 提供模型层，MaaS 和自研芯片提供基础设施能力，最终目标是把消费平台升级为 AI 时代的基础设施与应用平台。",
      segments: [
        {
          title: "中国电商：现金流底座",
          scale: "2025 年 12 月季度收入 1593.47 亿元，同比增长 6%",
          text: "淘天等业务仍是商家、消费者和现金流底座。它的任务不是高增长，而是稳定产生现金，支撑云 AI、即时零售和回购；当前问题是即时零售投入正在压低 EBITA。",
        },
        {
          title: "Cloud Intelligence：第二增长曲线",
          scale: "收入 432.84 亿元，同比增长 36%；adjusted EBITA 39.11 亿元",
          text: "这是估值重估最关键的业务。云承接企业 AI、MaaS、模型服务和算力需求，若持续高增且 EBITA 改善，阿里就不再只是成熟平台，而是有第二增长曲线的基础设施公司。",
        },
        {
          title: "Qwen / AI 生态：模型与场景入口",
          scale: "Qwen 月活超 3 亿，开源下载超 10 亿",
          text: "Qwen 的意义不只是模型能力，而是同时接入淘宝、天猫、高德、飞猪、支付宝和企业云场景。关键不是下载量本身，而是能否转化为 MaaS 收入、企业客户留存和消费端 AI 入口。",
        },
      ],
      moat: [
        {
          title: "强在哪里",
          text: "强在商家和消费者生态、支付与物流协同、阿里云基础设施、Qwen 模型生态、自研芯片、MaaS 能力和强资产负债表。单看任何一项都不是无敌，组合在一起才构成“有场景、有算力、有模型、有资本”的复合护城河。",
        },
        {
    ...
    valuationFrame: {
      intro: "阿里的估值判断不能只看“便宜”，也不能只看“AI 很强”。它的估值修复路径是三段式：核心电商现金流托底，云 AI 抬升增长中枢，回购把现金流转成每股价值；任何一段断掉，重估都会打折。",
      cards: [
        {
          title: "估值上行条件",
          text: "云收入继续 30%+ 增长，云 EBITA 保持改善，AI 产品收入持续高增，Qwen 生态转为商业化，同时核心电商 EBITA 和自由现金流恢复。",
        },
        {
          title: "估值压制因素",
        ...
        {
          title: "当前动作",
          text: "维持 A 池核心，但不因单季云 AI 高增就追价。更合理的是等下一季验证利润、现金流、即时零售亏损和 AI 商业化质量是否同步改善。",
        },
        {
          title: "真正触发升级的证据",
    ...
    valuationModel: {
      ...
      intro: "这是第一版估值模型样板，目标不是给一个精确目标价，而是把阿里的估值修复路径拆开：老业务给底、云 AI 给弹性、回购和净现金给保护，投入与折价负责扣分。",
      conclusion: "合理偏低，但不是无脑低估",
      read: "第一版分部估值给出的合理市值区间约 RMB 2.3-2.9 万亿元，中枢约 RMB 2.6 万亿元。当前结论的核心不是某一个旧股价点位，而是看最新市场价格折算后的市值是否仍低于合理区间中枢。若云 AI 增长、即时零售亏损收窄、自由现金流修复和回购执行同时改善，合理区间可向乐观情景靠拢；若自由现金流继续被投入吞噬，估值修复就会打折。",
      actionPolicy: {
      ...
      currentBreakdown: [
        {
          title: "核心电商现金流",
          text: "约 RMB 1.20-1.45 万亿元，占合理价值约 50%-55%。这是估值底座，不是成长故事。由于即时零售和用户体验投入压低 EBITA，这部分不能按巅峰利润给满估值。",
        },
        {
          title: "Cloud Intelligence",
          text: "约 RMB 0.35-0.55 万亿元，占比约 15%-20%。这是估值弹性来源。季度云收入 432.84 亿元、同比 +36%，年化收入约 1700+ 亿元；若 EBITA 继续改善，这部分估值权重可以上修。",
        },
        {
          title: "净现金与投资资产",
        ...
        {
          title: "AI / Qwen 期权",
          text: "约 RMB 0.10-0.25 万亿元，占比约 5%-10%。这是期权，不是已兑现利润。Qwen 月活、开源下载和 AI 产品高增提供想象力，但要等 MaaS 收入、企业客户和利润率证明。",
        },
        {
        ...
        {
          title: "折价与投入拖累",
          text: "扣减约 RMB 0.25-0.45 万亿元。港股/中概折价、即时零售投入、自由现金流同比 -71%、集团 adjusted EBITA 同比 -57%，共同解释了为什么它是合理偏低，而不是无脑低估。",
        },
      ],
      scenarios: [
        {
      ...
      triggers: [
        {
          title: "更积极分批的触发",
          text: "云继续 30%+ 增长且 EBITA 改善，自由现金流明显修复，即时零售亏损收窄，回购持续。四个条件至少要同时出现三项，才说明估值修复进入更健康阶段。",
        },
        {
          title: "继续等待的触发",
  ...
  gevernova: {
    ...
    tag: "美股",
    tagClass: "us",
    summary: "GE Vernova 最该盯的不是“电力需求很强”这句话，而是需求能否穿过订单、backlog、交付、利润率，最后变成自由现金流。",
    thesis: "GE Vernova 是发电、电网设备、电气化和服务链路上的电力系统升级平台；它的投资价值取决于电力周期能否持续转化为高质量 backlog、利润率和现金流。",
    action: "维持 A 池核心，并适度提升研究优先级",
    portfolioAction: "继续观察，不因电力主题热度追价；若 Q2/Q3 连续验证订单、利润率、自由现金流和 Prolec 并表质量，再重新评估更积极动作。",
    nextCheck: "2026Q2/Q3：订单是否继续高位，backlog 是否继续增长，Power / Electrification 利润率是否改善，自由现金流是否沿 50-60 亿美元全年指引推进，Prolec 并表是否增强而不是稀释质量。",
    positioning: "GE Vernova 的定位不是单一发电设备商，而是电力系统升级平台：一端连接燃气发电和服务，一端连接电网、变压器、电气化和数据中心用电需求，中间靠 backlog 和项目交付能力把长期需求变成收入与现金流。",
    products: "主营覆盖 Power、Electrification、Wind 和相关服务。Power 提供发电设备与服务底座，Electrification 承接电网/变压器/输配电稀缺，Wind 是拖累或修复期权；当前最关键的是这些业务能否把订单和 backlog 转化为利润率与自由现金流。",
    markets: "主要面向美国及全球电力投资、电网升级、数据中心电力配套、工业电气化和可靠电源需求。当前最强驱动来自北美电网设备紧缺、AI 数据中心用电增长，以及全球电力系统可靠性投资。",
    moatDetail: "它的优势在 installed base、长周期服务、燃气发电交付经验、电网设备能力、Prolec 对北美变压器链条的补强，以及更长 backlog 带来的可见性。弱点是项目型工业公司天然有执行风险：订单很强不等于利润率一定兑现，backlog 很长也不等于现金流一定顺畅。",
    business: "不是单一设备公司，而是在 Power、Electrification、Wind 和服务几条线上同时受益于全球电力系统升级；真正要看的是订单能否变成高质量现金流。",
    moat: "installed base、项目交付经验、Power 与 Electrification 协同、Prolec 补强北美电网设备，以及更长 backlog 可见性共同构成护城河。",
    financials: "当前财报最该看订单、backlog、利润率、自由现金流和指引，而不是只看电力主题热度。订单是入口，现金流才是最终兑现。",
    valuation: "研究上维持核心，但当前价格已经反映很多乐观预期；动作上要等订单、利润率和现金流连续兑现，而不是只凭长周期叙事加仓。",
    latestEvent: "2026Q1 同时出现订单 +71%、backlog 顺增 130 亿美元、自由现金流 48 亿美元和全年指引上修。",
    businessImpact: "这条财报的价值在于“四个环节同时亮”：需求进入订单，订单推高 backlog，交付带来利润率，自由现金流开始兑现。它让 GE Vernova 更像完整的电力系统升级平台，而不是只吃某一段设备景气。",
    valuationImpact: "研究上继续强化，但当前价格已经接近或超过第一版合理区间上沿；资金动作仍要等 Q2/Q3 验证订单、利润率、自由现金流和 Prolec 整合是否持续兑现。",
    risk: "Wind 板块拖累、项目执行风险、并购整合质量和利润率波动。",
    focus: [
      "2026Q2/Q3 订单与 backlog 是否继续高位，而不是 Q1 一次性强",
      "Power 和 Electrification 业务利润率是否继续改善",
      "Prolec 并表后 Electrification 增长质量和现金流质量",
      "自由现金流是否继续向 50-60 亿美元全年指引靠拢",
      "Wind 拖累是否收窄，项目执行是否出现新的成本压力",
    ],
    trackingGuide: [
      "先看哪里：季度业绩和业绩会。重点看订单、backlog、利润率和自由现金流。",
      "怎么判断：如果订单继续强、backlog 继续增、利润率和自由现金流同步改善，说明电力升级叙事正在真正兑现；如果只有订单没有现金流，就要保守。",
      "再看外部：观察美国电网投资、变压器供需、数据中心电力需求、燃气发电排产和 Prolec 整合情况，看需求和执行是不是同向强化。",
    ],
    financeMap: {
    ...
    businessMap: {
      intro: "GE Vernova 不是单一电力设备商，而是站在发电、电网设备、电气化和服务几条链路上的电力系统升级平台。看它要按“电从哪里来、怎么接入电网、设备如何服务、哪里拖后腿”来拆：Power 是可靠电源底盘，Electrification 是电网稀缺主线，服务和 installed base 提供韧性，Wind 是需要持续盯的拖累/修复项。",
      segments: [
        {
          title: "Power：发电设备和服务底座",
          scale: "Gas Power backlog / slot reservation agreements 100GW",
          text: "Power 是公司最核心的周期兑现抓手之一。AI 数据中心、工业回流和电网可靠性需求都需要稳定电源，燃气发电设备和长期服务合同让 GE Vernova 直接受益。关键不是订单多，而是排产、交付、服务利润率和现金回款能否持续变好。",
        },
        {
          title: "Electrification：电网设备主线",
          scale: "Prolec 并表后更重要",
          text: "这条线对应电网升级、变压器、输配电和数据中心电力连接，是当前最容易被低估的主线之一。Prolec 交易增强了北美变压器和电网设备供给能力；后续要看并表后是否提升订单质量、利润率和交付能力，而不是只扩大收入规模。",
        },
        {
          title: "Wind：潜在拖累和可选改善",
          scale: "仍需谨慎跟踪",
          text: "Wind 不是当前最强逻辑，但它会影响整体利润率、项目风险和市场情绪。如果 Wind 拖累收窄，会给估值提供弹性；如果继续恶化，会抵消 Power / Electrification 的强化，甚至让市场重新担心公司项目执行能力。",
        },
        {
          title: "服务与 installed base：现金流韧性",
          scale: "存量设备维护、升级和长期服务",
          text: "服务业务不像新设备订单那样吸引眼球，但它决定工业公司的现金流稳定性。已有设备基数越大，后续维护、升级、零部件和长期服务收入越可见，也越能平滑设备周期波动。",
        },
      ],
      moat: [
        {
          title: "强在哪里",
          text: "强在 installed base、项目交付经验、发电设备服务能力、电网设备布局、变压器链条补强，以及越来越长的 backlog 可见性。这些能力不是一两年能复制的，尤其在供给紧张和交付周期拉长时更有价值。",
        },
        {
          title: "和普通设备公司差别",
          text: "普通设备公司更容易只吃单一产品周期，GE Vernova 同时站在发电、电网、服务和电气化几条链路上，更接近电力系统升级平台。它的机会不是单个设备涨价，而是整个电力系统资本开支重新抬升。",
        },
        {
          title: "护城河的弱点",
          text: "它仍然是工业项目公司，项目执行、供应链、并购整合、Wind 拖累和周期节奏都会影响利润率与现金流。backlog 长是优势，但如果项目定价、成本控制或交付节奏出问题，长 backlog 也可能变成长期风险暴露。",
        },
      ],
    },
    valuationFrame: {
    ...
    valuationModel: {
      ...
      actionPolicy: {
        fundamentalState: "订单、backlog 和自由现金流同时强化，但价格已经处于乐观区间附近",
        low: "价格低于保守区间时，先复核是否出现订单、利润率、Wind 或项目执行恶化；若没有恶化，可提高研究和分批复核优先级。",
        belowMid: "价格低于中枢时，可以复核机会，但必须确认订单、backlog、Power / Electrification 利润率和自由现金流仍沿原假设兑现。",
        nearMid: "价格接近中枢时，以继续观察为主，等待 Q2/Q3 对订单、backlog、Prolec 并表和自由现金流的连续验证。",
        nearHigh: "价格接近上沿时，不因电力主题追价；除非自由现金流和利润率继续超预期，否则等待验证更稳。",
        expensive: "价格高于乐观区间时，控制追价。只有 Q2/Q3 继续上修 FCF、Power / Electrification 利润率改善且 Wind 拖累收窄，才重新评估动作。",
      },
      priceRange: {
        symbol: "GEV",
        currency: "USD",
  ...
  luxshare: {
    ...
    tag: "A 股",
    tagClass: "cn",
    summary: "立讯现在最该看的不是股价涨了多少，而是复杂制造平台的扩张质量：三条业务线增长能否转成现金流、周转和资本回报。",
    thesis: "立讯是中国复杂精密制造与系统集成能力的代表性公司之一，但现阶段研究重点应从“是否优秀”转向“扩张质量是否足够高”。",
    action: "维持 A 池跟踪，但现金流质量与三条业务线贡献进入强验证期",
    portfolioAction: "公司研究层面继续观察，不因价格上涨追高；等待下一轮财报验证经营现金流、存货、应收和新业务利润质量。",
    nextCheck: "下一轮财报重点看四件事：经营现金流是否修复、存货是否继续占用现金、应收是否开始拖累、汽车电子和通信/数据中心是否贡献更高质量增长。",
    positioning: "立讯的定位是复杂精密制造和系统集成平台，不是单一消费电子代工厂。它的价值在于把消费电子沉淀的制造、连接、模组和供应链能力迁移到汽车电子、通信及数据中心。",
    products: "主营覆盖消费电子精密制造、连接器、声学、通信、汽车电子、数据中心互连和系统级组装等。真正要看的是这些产品线是否形成多业务协同，而不是简单堆收入。",
    markets: "主要面向全球消费电子、通信、数据中心和汽车产业链客户。当前最关键的是能否从消费电子大客户底盘，逐步走向多业务引擎，并改善利润率和现金回收。",
    moatDetail: "它的优势在于复杂制造执行力、客户协同、快速扩产、供应链管理和系统集成能力。和普通制造企业相比，它更强在把复杂项目稳定、低成本、大规模交付；但制造护城河最终必须由现金流和资本回报证明。",
    business: "长期逻辑来自复杂制造平台化：消费电子给规模和现金流底座，汽车电子给第二增长曲线，通信/数据中心给高频高速互连和 AI 基础设施增量。",
    moat: "复杂制造、客户绑定、快速扩产和系统集成构成护城河，但护城河是否够强，要看收入扩张是否带来更好的现金流、周转和资本回报。",
    financials: "把利润拆成现金和周转：先看经营现金流，再拆经营性应付、存货、经营性应收三项，最后看汽车电子和通信/数据中心增长有没有改善利润和现金质量。",
    valuation: "估值能否站得住，核心不是收入利润还在增长，而是消费电子底盘、汽车电子、通信/数据中心三条线能否共同转化为自由现金流和资本回报。",
    ...
    risk: "客户集中、存货占用、应收恶化、资本开支回报不足、新业务扩张不及预期和现金流质量恶化。",
    focus: [
      "经营性应付是否继续回落（付款/结算节奏）",
      "存货占用是否继续扩大（爬坡与去化效率）",
    ...
    financeMap: {
      intro: "立讯的财务地图要按“利润有没有变成现金”来读。2025 年的关键不是有没有增长，而是增长过程里现金被哪些科目占用：应付回落代表供应商结算压力，存货增加代表爬坡/备货占用，应收变化代表客户回款质量。",
      rows: [
        {
          metric: "经营现金流净额",
          value: "+173.25 亿元",
          change: "同比下降 36.11%",
          read: "全年仍为正，说明不是现金流崩坏；但同比明显下降，说明利润增长没有完全转成现金，扩张质量必须复核。",
        },
        {
          metric: "2025H1 经营现金流",
          value: "-16.58 亿元",
        ...
        },
        {
          ...
          value: "-135.16 亿元",
          change: "现金流调节表最大拖累项",
          read: "这是本轮现金流下降的主因。它对应向供应商付款、应付减少或结算节奏变化，不等于客户回款崩坏，但会降低现金流弹性。",
        },
        {
          metric: "存货",
          value: "-33.83 亿元",
          change: "存货增加导致现金占用",
          read: "对应备货、项目爬坡、并表或交付节奏。它不是坏账风险，但会占用现金；后续要看能否快速转成收入、利润和回款。",
        },
        {
          metric: "经营性应收项目",
          value: "+60.06 亿元",
          change: "对经营现金流为正贡献",
          read: "这是反证项：2025 年现金流压力不能简单归因为客户回款崩坏。下一步要看它是否从贡献转为拖累。",
        },
        {
          metric: "消费电子收入",
          value: "2642.66 亿元",
          change: "占总收入 79.52%",
          read: "这是规模和现金流底盘，也是营运资本波动的最大来源。大客户排产、账期和供应链结算会直接影响现金流。",
        },
        {
          metric: "汽车电子收入",
          value: "392.55 亿元",
          change: "同比增长 185.34%",
          read: "这是第二增长曲线，但高增长和并表整合也可能带来存货、在制品和营运资本占用。要看它是否贡献利润和现金。",
        },
      ],
      bridge: [
        {
          label: "第一层：全年现金流没有崩",
          text: "经营现金流净额 +173.25 亿元，仍然是正数，所以不能把它直接定性为现金流危机；真正的问题是现金流质量下降。",
        },
        {
          label: "第二层：同比下降需要警惕",
          text: "同比下降 36.11%，说明利润增长没有同等质量地转化成现金。制造公司如果长期“利润好看、现金不好”，估值会被压低。",
        },
        {
          label: "第三层：主因是应付回落",
        ...
        {
          label: "第四层：存货是次要占用",
          text: "存货增加 -33.83 亿元，占用了现金。它可能来自备货、项目爬坡或并表整合；如果后续不能释放，就会变成扩张质量风险。",
        },
        {
      ...
      notes: [
        {
          title: "当前结论",
          text: "立讯不是被这一组现金流数据直接否定，而是进入“现金流质量验证期”。它仍是复杂制造平台，但平台化价值必须由现金流和周转证明。",
        },
        {
          title: "下一季最该看",
          text: "下一季继续拆三项：应付是否继续大幅减少、存货是否继续增加、应收是否从正贡献转为拖累；同时看汽车电子和通信/数据中心是否改善利润质量。",
        },
        {
          title: "真正的风险信号",
          text: "如果应付继续回落、存货继续堆、应收也开始拖累，同时经营现金流再次大幅转负，那才是需要下调确信度和估值中枢的组合信号。",
        },
      ],
    },
    businessMap: {
      intro: "立讯不是简单的“苹果链代工厂”。更准确的理解是：它以消费电子大客户体系沉淀制造、连接、模组和供应链能力，再把这些能力迁移到汽车电子、通信及数据中心。业务地图要回答的不是“有没有新业务”，而是新业务是否提高利润质量和现金回报。",
      segments: [
        {
          title: "消费电子：现金流和规模底盘",
          scale: "2025 收入 2642.66 亿元，占比 79.52%",
          text: "这是公司绝对体量最大的业务，也是供应链结算、客户账期和现金流波动的主来源。它贡献规模、制造能力和客户协同，但也带来客户集中、排产变化和营运资本波动。它决定估值底盘是否稳。",
        },
        {
          title: "汽车电子：第二增长曲线",
          scale: "2025 收入 392.55 亿元，同比增长 185.34%",
          text: "这条线的价值在于把连接器、线束、模组和系统集成能力迁移到汽车产业链。如果它只带来收入增速，但带不来利润率和现金流改善，估值贡献会打折；如果能持续拿到系统级项目并改善盈利质量，它才是真正的第二曲线。",
        },
        {
          title: "通讯及数据中心：潜在增量",
          scale: "2025 收入 245.68 亿元，占比 7.39%",
          text: "这个板块还不是最大收入来源，但高频高速互连、线缆、散热和系统级交付如果进入数据中心客户体系，可能成为估值重估来源。当前不能先把它当 AI 概念股，要等收入占比、毛利率和客户导入证据。",
        },
      ],
      moat: [
        {
          title: "强在哪里",
          text: "强在复杂项目的制造执行力、快速扩产、客户协同和供应链管理。它不是靠单一专利赢，而是靠把复杂产品稳定、低成本、大规模交付出来，并能随客户需求扩品类。",
        },
        {
          title: "和普通制造公司差别",
        ...
        {
          title: "护城河的弱点",
          text: "制造平台的护城河最终必须体现在现金流和资本回报。如果收入扩张依赖更多存货、更多应付波动、更重资本投入或更长账期，护城河就会被财务质量稀释。",
        },
      ],
    },
    valuationFrame: {
      intro: "立讯的估值不能只用“收入利润增长”判断。它的估值中枢取决于三件事：消费电子底盘是否稳，汽车电子和通信/数据中心是否真的贡献更高质量增长，以及经营现金流和营运资本是否证明扩张可持续。",
      cards: [
        {
          title: "估值上行条件",
          text: "如果后续经营现金流修复，存货和应付压力缓解，同时汽车电子、通信及数据中心继续增长并改善利润质量，市场才有理由把它看成多业务制造平台，而不是单一消费电子链公司。",
        },
        {
          title: "估值压制因素",
        ...
        {
          title: "当前动作",
          text: "现阶段不是因为现金流下降就否定公司，也不是因为收入利润增长就直接提高动作。更合理的是维持跟踪，等待下一轮财报把应付、存货、应收和新业务利润质量验证清楚。",
        },
        {
          title: "真正触发升级的证据",
          text: "经营现金流连续修复、存货周转稳定、应收不恶化，汽车电子和通信/数据中心增长没有吞噬现金流，同时客户集中风险没有进一步扩大。",
        },
      ],
    },
    valuationModel: {
      snapshotDate: "估值快照：2026-04-15 可得市场数据；另参考你提到的近期约 68 元价格",
      intro: "立讯这一版估值模型不再只问“公司好不好”，而是问：市场给消费电子底盘、汽车电子、通信/数据中心分别定了多少价？当前价格又预支了多少现金流修复和新业务兑现？",
      conclusion: "58-60 元附近接近合理中枢；68 元附近偏向乐观区间，不适合无验证追价",
      read: "按 2026-04-15 可得快照，立讯股价约 58.78 元、市值约 4283 亿元、TTM PE 约 26 倍、Forward PE 约 20.8 倍。第一版合理市值区间约 4000-4700 亿元，中枢约 4350 亿元；如果股价显著高于这一区间，对应的隐含前提就是：消费电子底盘稳定、汽车电子继续放量、通信/数据中心形成增量，且经营现金流必须修复。",
      actionPolicy: {
      ...
      currentBreakdown: [
        {
          title: "消费电子复杂制造底盘",
          text: "约 2800-3300 亿元。这是估值底座，依据是 2025 年消费电子收入 2642.66 亿元、占总收入 79.52%。它稳定但不应按高成长科技股估值，因为客户集中、议价压力和营运资本波动都需要折价。",
        },
        {
          title: "汽车电子第二增长曲线",
          text: "约 900-1400 亿元。这是估值弹性的主要来源，依据是 2025 年汽车电子收入 392.55 亿元、同比增长 185.34%。但它只有在利润率、项目落地、并表整合和现金回收同步改善时，才值得给更高权重。",
        },
        {
          title: "通信及数据中心增量",
          text: "约 400-800 亿元。依据是 2025 年通信及数据中心收入 245.68 亿元、占比 7.39%。它可以带来 AI 基础设施相关的重估想象，但当前仍是可选项，必须等客户导入、收入占比和毛利率证据。",
        },
        {
          title: "其他业务与系统集成协同",
        ...
        {
          title: "现金流与客户集中折价",
          text: "扣减约 300-700 亿元。原因是 2025 年经营现金流 +173.25 亿元但同比下降 36.11%，且主要受应付回落和存货占用影响；如果后续修复，这个折价可以收窄，反之会扩大。",
        },
      ],
      scenarios: [
        {
        ...
        },
        {
          ...
          text: "利润增长延续，经营现金流部分修复，应付/存货/应收没有同时恶化，汽车电子和通信数据中心继续增长。这是当前最适合采用的主情景。",
        },
        {
          title: "乐观情景：约 5000-6000 亿元",
          text: "现金流明显修复，汽车电子和数据中心开始贡献更清晰利润，客户结构改善，市场把立讯从消费电子链龙头重估为多业务复杂制造平台。",
        },
      ],
      implied: [
        {
        ...
        {
          title: "68 元附近隐含什么",
          text: "市场已经在预支更强的下一轮验证：经营现金流改善、新业务继续高增、客户集中风险没有恶化。这个价格下容错率变低。",
        },
        {
          title: "真正决定估值方向的不是涨了多少",
          text: "关键是现金流是否跟上利润。如果利润继续增长但现金流、存货、应收变差，估值中枢会被压低；如果三条业务线增长同时改善现金质量，估值中枢才有上修空间。",
        },
      ],
      triggers: [
        {
          title: "可以更积极分批的触发",
          text: "经营现金流明显修复，应付不再大幅回落，存货没有继续堆高，应收没有转为明显拖累，同时汽车电子和通信数据中心继续增长。",
        },
        {
          title: "继续观望的触发",
  ...
  constellation: {
    ...
    tag: "美股",
    tagClass: "us",
    summary: "Constellation 的关键不只是“核电很稀缺”，而是能不能把稳定、清洁、可调度电力签成长期合同，并最终变成 EPS、自由现金流和股东回报。",
    thesis: "Constellation 正在从核电稀缺资产持有者，演进为面向 AI 数据中心、电气化和再工业化的成长型电力平台；核心验证是合同溢价、Calpine 整合和现金流质量。",
    action: "维持 A 池核心，并提升合同与资本回报验证优先级",
    portfolioAction: "继续观察，价格回到合理区间中下部时可以复核机会；但是否更积极，仍取决于 2026 EPS、长期合同溢价、Calpine 整合和自由现金流是否共同兑现。",
    nextCheck: "下一次重点看 2026 adjusted operating EPS 是否维持 11-12 美元，147 million MWh 可用核电电量是否签出高质量溢价合同，Calpine 是否增厚 EPS/现金流，growth capex 是否有足够回报。",
    positioning: "Constellation 的定位是稳定、清洁、可调度电力平台。它不只是核电资产持有者，而是在用核电、天然气、地热和商业合同能力，向数据中心、大型工业客户和再工业化需求出售长周期可靠电力。",
    products: "主营包括核电发电、天然气发电、地热及其他清洁能源、电力零售和大型客户长期供电方案。当前最关键的产品不是某个电厂，而是 PPA/长期供电协议：把稳定电力锁定给数据中心和大企业，并通过合同价格体现稀缺性。",
    markets: "主要面向美国电力市场、大型商业和工业客户、数据中心客户，以及需要稳定低碳电力的企业。当前驱动力来自 AI 数据中心、电气化、再工业化、能源安全和可靠电源不足。",
    moatDetail: "它的优势在于稀缺核电资产、稳定可调度电力、核电运营经验、长期供电合同能力和并购后更大的商业平台。和普通公用事业公司相比，它更有成长弹性；和单一发电商相比，它更能把核电、天然气和地热组合打包成客户可签约的可靠电力能力。",
    business: "核电底座仍是核心，但真正改变公司边界的是 Calpine 并购后的 55GW 电力平台和商业合同能力。",
    moat: "稳定零碳电力资产、核电运营经验、55GW 发电平台、PPA/长期供电合同能力、数据中心客户需求和更大的商业客户覆盖。",
    financials: "当前最该看 2026 adjusted operating EPS、Base EPS 增长目标、147 million MWh 核电电量签约溢价、growth capex 回报、回购和自由现金流。EPS 是增长口径，FCF 是兑现口径。",
    valuation: "估值不应只看核电主题，也不能只看股价回落；要看稀缺电力能否通过长期合同、EPS 增长和自由现金流持续兑现。",
    latestEvent: "2026 Outlook 给出 adjusted operating EPS 11-12 美元、2026-2029 Base EPS 增长 20%+，并明确 147 million MWh 核电电量溢价尚未纳入基础增长展望。",
    businessImpact: "这说明公司主线已经从“拥有稀缺核电”升级为“把稀缺电力卖成长期合同”。Calpine 扩大了天然气、地热和商业平台，147 million MWh 年度可用核电电量则是未来 PPA/长期合同重定价的关键资源。",
    valuationImpact: "长期逻辑强化，且当前价格回落后更值得复核；但动作仍要等 2026 EPS、合同溢价、growth capex 回报、Calpine 整合和自由现金流一起验证。",
    risk: "Calpine 整合、监管资产剥离、growth capex 回报不及预期、电力价格波动、核电资产运行和政策风险。",
    focus: [
      "147 million MWh 年度可用核电电量能否签出高质量长期合同",
      "数据中心 PPA / 长期供电协议是否继续扩张并体现价格溢价",
      "Calpine 整合后的 EPS 和自由现金流协同兑现情况",
      "growth capex 是否获得足够回报，而不是只消耗现金",
      "核电资产延寿、重启、检修与安全运行质量",
    ],
    trackingGuide: [
      "先看哪里：季度业绩、重大 PPA/长期供电合同、Calpine 整合进展和核电运营质量。",
      "怎么判断：如果长期合同扩张、价格溢价、EPS 指引和自由现金流一起改善，说明它正在从稀缺资产走向成长平台；如果只有故事没有合同和现金流兑现，就要警惕。",
      "再看外部：跟踪美国电力政策、核电支持政策、数据中心用电需求、天然气电价和监管审批，看外部环境是不是继续强化这条主线。",
    ],
    financeMap: {
    ...
    businessMap: {
      intro: "Constellation 不是普通公用事业公司。它的核心价值来自稳定、清洁、可调度电力资产，尤其是核电；Calpine 并入后，公司又补上天然气、地热和更大商业平台，使它更能服务 AI 数据中心、电气化和再工业化带来的大负荷需求。看这家公司要按三层拆：底层是可调度电力资产，中层是 PPA/长期供电合同，上层是 EPS、自由现金流和资本配置。",
      segments: [
        {
          title: "核电：最稀缺的底座",
          scale: "147 million MWh 年度可用核电电量是未来签约和溢价的关键",
          text: "核电的价值在于稳定、清洁、可调度。147 million MWh 可以理解为每年可拿去签约的核电电量池，约等于 1470 亿度电。对数据中心和工业客户来说，持续供电比单纯低价电更重要，这给核电长期合同提供溢价空间。",
        },
        {
          title: "Calpine：补上天然气、地热和商业平台",
          scale: "合并后约 55GW 发电组合",
          text: "Calpine 是美国大型独立发电平台，核心价值不是给 Constellation 加一个概念，而是补上天然气灵活电源、地热资产和更大的商业客户平台。合并后公司能用核电提供清洁稳定底座，用天然气补峰和提高供电灵活性。",
        },
        {
          title: "PPA / 长期合同：把资产稀缺性变成利润",
          scale: "面向数据中心、大型商业和工业客户",
          text: "真正的价值不是“有电”，而是能把稳定电力签成长期、高质量、可定价的合同。PPA 可以理解为客户和发电商签的长期购电协议，锁定电量、期限和价格。CyrusOne 这类数据中心协议就是验证方向。",
        },
        {
          title: "资本配置：回购和 growth capex 的平衡",
          scale: "50 亿美元回购授权，39 亿美元 growth capital",
          text: "这家公司不是简单收租型资产。管理层一边回购，一边投 growth capex 捕捉电力需求增长。关键是新增资本项目是否真的带来高回报，否则 EPS 好看但自由现金流跟不上，估值会受压。",
        },
      ],
      moat: [
        {
          title: "强在哪里",
          text: "强在核电稀缺性、稳定可调度电力、运营经验、客户合同能力和 55GW 组合规模。AI 数据中心需要的是长期、稳定、可用且越来越偏低碳的电力，这正是公司资产最稀缺的地方。",
        },
        {
          title: "和普通公用事业差别",
          text: "普通公用事业更偏监管回报和稳定分红；Constellation 的弹性来自核电重定价、数据中心长期合同、Calpine 整合和更主动的资本配置。因此它不能只用传统公用事业低增长估值看，但也不能忽视自由现金流约束。",
        },
        {
          title: "护城河的弱点",
          text: "核电资产虽稀缺，但受监管、安全、检修和政策影响；Calpine 整合复杂；如果电力价格、大客户需求或 PPA 价格低于预期，成长叙事会被重新定价。P/FCF 偏高时，现金流兑现慢会被市场放大。",
        },
      ],
    },
    valuationFrame: {
    ...
    valuationModel: {
      ...
      actionPolicy: {
        fundamentalState: "核电稀缺和 AI 用电逻辑仍强，但自由现金流、合同溢价和 Calpine 整合还在验证期",
        low: "价格低于保守区间时，先复核是否出现核电运营、政策、电价或 Calpine 整合恶化；若没有恶化，可提高研究和分批复核优先级。",
        belowMid: "价格低于中枢时，可以复核机会，但必须确认 2026 EPS 指引、PPA/长期合同、Calpine 协同和自由现金流没有破坏原估值假设。",
        nearMid: "价格接近中枢时，以继续观察为主，等待下一次 EPS、合同溢价、growth capex 回报和自由现金流验证。",
        nearHigh: "价格接近上沿时，不因 AI 用电或核电主题追价；除非合同溢价和 FCF 明确改善，否则等待更稳。",
        expensive: "价格高于乐观区间时，控制追价。只有 147 million MWh 核电电量签约溢价、Calpine 协同和自由现金流明显上修，才重新评估动作。",
      },
      priceRange: {
        symbol: "CEG",
        currency: "USD",
