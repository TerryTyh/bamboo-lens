const COMPANY_DATA = {
  nvidia: {
    ...
    latestEvent: "FY26 Q4 数据中心收入 623.14 亿美元，FY27 Q1 收入指引 780 亿美元，AI 工厂逻辑继续强化。",
    businessImpact: "这强化了公司从训练卖卡，走向 AI 工厂平台的长期逻辑；Data Center 已经占季度收入约九成。",
    valuationImpact: "研究上继续强化，但仓位动作仍要等 FY27 Q1 验证数据中心收入、毛利率、推理需求和超大客户 capex。",
    ...
    businessMap: {
      intro: "NVIDIA 现在不应只被理解为 GPU 芯片公司。更准确的理解是：它用 GPU、网络、CPU、整机系统、CUDA 软件生态和 AI 工厂方案，把自己放在全球 AI 基础设施资本开支的核心位置。",
      segments: [
        {
        ...
        {
          title: "AI 工厂平台：长期边界",
          scale: "Rubin、NVLink、网络、存储、系统级合作",
          text: "未来价值不只来自单颗 GPU，而来自 AI 工厂级系统：芯片、网络、光互连、整机、软件和客户多年路线图共同构成平台能力。",
        },
      ],
      moat: [
        {
          title: "强在哪里",
          text: "强在 CUDA 生态、硬件迭代、系统级交付、网络互连、客户绑定和开发者迁移成本。竞争对手很难只靠单颗芯片参数追平整套生态。",
        },
        {
          title: "和普通芯片公司差别",
          text: "普通芯片公司卖的是部件，NVIDIA 越来越像卖 AI 基础设施标准。客户买的不只是 GPU，而是训练、推理、网络和软件协同能力。",
        },
        {
          title: "护城河的弱点",
          text: "高度依赖超大客户 capex、先进制程供应链和出口规则。如果客户自研 ASIC 或 capex 放缓，市场预期会快速重估。",
        },
      ],
    },
    valuationFrame: {
      ...
      cards: [
        ...
        {
          title: "真正触发升级的证据",
          text: "连续几个季度 Data Center、毛利率、推理需求和客户 capex 同向强化，同时库存和应收没有出现过热信号。",
        },
      ],
    },
    valuationModel: {
