window.BAMBOO_LENS_DECISION_DEPOSITION = {
  ...
  "source_event_store_at": "2026-06-01T22:36:15",
  "source_decision_impact_at": "2026-06-01T22:36:15",
  "items": [
    {
      "company": "nvidia",
      "company_name": "NVIDIA",
      "event_index": 0,
      "event_title": "提出“AI 工厂”基础设施框架：用 tokens 衡量产能与单位经济，强调全栈协同与智能体/持续推理负载",
      ...
      "recommended_updates": [
        {
          ...
          "suggestion": "把最新事件更新为「提出“AI 工厂”基础设施框架：用 tokens 衡量产能与单位经济，强调全栈协同与智能体/持续推理负载」；业务影响写入：业务层面，这条框架把 NVIDIA 的竞争边界从“卖 GPU”推进到“卖 AI 工厂的全栈产能与效率”：推理/智能体负载要求 GPU 之外还要网络、存储/内存层级、编排软件与 CPU 执行协同，天然有利于 NVIDIA 用平台方式打包（计算+网络+软件）并提升系统级粘性。对客户侧，它也把讨论从“买多少卡”转为“单位能耗产出多少 tokens、每 token 成本是多少、系统上线率/利用率如何”，会影响云厂商/企业对基础设施选型与优化的 KPI。；估值/动作写入：估值/动作上，这条事件更像“解释为"
        },
        {
          "target": "公司理解",
          "fields": [
          ...
          "suggestion": "业务层面，这条框架把 NVIDIA 的竞争边界从“卖 GPU”推进到“卖 AI 工厂的全栈产能与效率”：推理/智能体负载要求 GPU 之外还要网络、存储/内存层级、编排软件与 CPU 执行协同，天然有利于 NVIDIA 用平台方式打包（计算+网络+软件）并提升系统级粘性。对客户侧，它也把讨论从“买多少卡”转为“单位能耗产出多少 tokens、每 token 成本是多少、系统上线率/利用率如何”，会影响云厂商/企业对基础设施选型与优化的 KPI。"
        },
        {
          "target": "财务数据地图",
          "fields": [
        ...
        },
        {
          ...
          "suggestion": "估值/动作上，这条事件更像“解释为什么平台溢价可能持续”的材料，而不是短期交易触发。若后续产品/客户案例能持续把 tokens/W 与每 token 成本显著改善，并转化为更高利用率/更强定价或更高软件附加值，则支撑更高质量的收入与更稳定的毛利结构；反之若只是口号而无法被财报中的收入结构（网络/软件占比）、毛利率、供给与客户 capex 兑现验证，则应降低对平台化叙事的权重。动作上维持核心跟踪，优先把验证点落到“单位经济指标是否在客户侧可被观测”。"
        },
        {
          "target": "跟踪重点与风险",
          "fields": [
          ...
          "suggestion": "在后续 NVIDIA 财报/客户发布中，优先寻找“tokens/W、每 token 成本、利用率、上线率”这类可落地口径是否被反复使用，并观察其是否与毛利率/收入结构变化对应。；跟踪 Data Center 收入中网络/软件/系统占比（或相关披露）是否持续提升，以验证“全栈协同”是否转化为更高的系统级收入。；关注超大云厂商与企业客户的 capex/部署节奏：是否从训练扩展到持续推理/智能体生产，及其对功耗/散热/机房改造的约束是否成为边界条件。"
        }
      ],
      "writeback_plan": [
        {
          "section": "当前结论",
          "plan": "用「提出“AI 工厂”基础设施框架：用 tokens 衡量产能与单位经济，强调全栈协同与智能体/持续推理负载」更新最新事件；当前结论只写这条事件对主线判断的增量，不覆盖长期判断底稿。"
        },
        {
          "section": "公司理解",
          "plan": "业务层面，这条框架把 NVIDIA 的竞争边界从“卖 GPU”推进到“卖 AI 工厂的全栈产能与效率”：推理/智能体负载要求 GPU 之外还要网络、存储/内存层级、编排软件与 CPU 执行协同，天然有利于 NVIDIA 用平台方式打包（计算+网络+软件）并提升系统级粘性。对客户侧，它也把讨论从“买多少卡”转为“单位能耗产出多少 tokens、每 token 成本是多少、系统上线率/利用率如何”，会影响云厂商/企业对基础设施选型与优化的 KPI。"
        },
        {
          "section": "财务数据地图",
        ...
        {
          "section": "估值模型",
          "plan": "估值/动作上，这条事件更像“解释为什么平台溢价可能持续”的材料，而不是短期交易触发。若后续产品/客户案例能持续把 tokens/W 与每 token 成本显著改善，并转化为更高利用率/更强定价或更高软件附加值，则支撑更高质量的收入与更稳定的毛利结构；反之若只是口号而无法被财报中的收入结构（网络/软件占比）、毛利率、供给与客户 capex 兑现验证，则应降低对平台化叙事的权重。动作上维持核心跟踪，优先把验证点落到“单位经济指标是否在客户侧可被观测”。"
        },
        {
          "section": "跟踪重点与风险",
          "plan": "在后续 NVIDIA 财报/客户发布中，优先寻找“tokens/W、每 token 成本、利用率、上线率”这类可落地口径是否被反复使用，并观察其是否与毛利率/收入结构变化对应。；跟踪 Data Center 收入中网络/软件/系统占比（或相关披露）是否持续提升，以验证“全栈协同”是否转化为更高的系统级收入。；关注超大云厂商与企业客户的 capex/部署节奏：是否从训练扩展到持续推理/智能体生产，及其对功耗/散热/机房改造的约束是否成为边界条件。"
        }
      ],
      "reason": "这是一条“叙事/框架”类事件：原文的增量不是新增某个可立刻计入收入的产品，而是用“AI 工厂 = 持续制造 tokens 的基础设施”把 NVIDIA 的 GPU、网络、系统与软件栈统一到同一套单位经济指标上。对研究而言，它提供了把后续产品发布与客户 capex 讨论落到可验证指标（tokens/W、每 token 成本、利用率）的框架，可用于公司页“业务理",
      "valuation_impact": "估值/动作上，这条事件更像“解释为什么平台溢价可能持续”的材料，而不是短期交易触发。若后续产品/客户案例能持续把 tokens/W 与每 token 成本显著改善，并转化为更高利用率/更强定价或更高软件附加值，则支撑更高质量的收入与更稳定的毛利结构；反之若只是口号而无法被财报中的收入结构（网络/软件占比）、毛利率、供给与客户 capex 兑现验证，则应降低对平台化叙事的权重。动作上维持核心跟踪，优先把验证点落到“单位经济指标是否在客户侧可被观测”。",
      "next_verification": [
        "在后续 NVIDIA 财报/客户发布中，优先寻找“tokens/W、每 token 成本、利用率、上线率”这类可落地口径是否被反复使用，并观察其是否与毛利率/收入结构变化对应。",
        "跟踪 Data Center 收入中网络/软件/系统占比（或相关披露）是否持续提升，以验证“全栈协同”是否转化为更高的系统级收入。",
        "关注超大云厂商与企业客户的 capex/部署节奏：是否从训练扩展到持续推理/智能体生产，及其对功耗/散热/机房改造的约束是否成为边界条件。"
      ],
    ...
    },
    {
      ...
      "company_name": "NVIDIA",
      "event_index": 1,
      "event_title": "Vera CPU 初步基准披露：88 核 + 1.2TB/s 内存带宽，瞄准智能体 AI 工厂的 CPU 瓶颈与能效",
      ...
      "recommended_updates": [
        {
          ...
          "suggestion": "把最新事件更新为「Vera CPU 初步基准披露：88 核 + 1.2TB/s 内存带宽，瞄准智能体 AI 工厂的 CPU 瓶颈与能效」；业务影响写入：业务层面，Vera CPU 的意义不在于单独卖 CPU，而在于补齐“GPU + CPU + 网络 + 软件编排”的系统方案：智能体工作流往往包含大量 CPU 密集型任务（代码编译/运行时执行/数据压缩/数据库查询/系统协调），这些环节若成为瓶颈，会限制整套 AI 工厂的端到端吞吐与利用率。若 Vera 以 Arm 生态进入 OEM/整机方案（与 NVLink/网络/软件栈协同），则会提升 NVIDIA 在企业本地部署与云厂商平台中的系统粘性。；估值/动作写入：估值/动作上，Vera"
        },
        {
          "target": "公司理解",
          "fields": [
          ...
          "suggestion": "业务层面，Vera CPU 的意义不在于单独卖 CPU，而在于补齐“GPU + CPU + 网络 + 软件编排”的系统方案：智能体工作流往往包含大量 CPU 密集型任务（代码编译/运行时执行/数据压缩/数据库查询/系统协调），这些环节若成为瓶颈，会限制整套 AI 工厂的端到端吞吐与利用率。若 Vera 以 Arm 生态进入 OEM/整机方案（与 NVLink/网络/软件栈协同），则会提升 NVIDIA 在企业本地部署与云厂商平台中的系统粘性。"
        },
        {
          "target": "财务数据地图",
          "fields": [
        ...
        },
        {
          ...
          "suggestion": "估值/动作上，Vera 目前仍属于“路线图兑现前”的材料：正面在于给出了可量化的规格与能效口径（88 核、1.2TB/s、功耗结构），并获得第三方媒体初步背书；限制在于量产时间、供给、真实 TCO/性能/兼容性与客户采用尚未验证。动作上不应因单篇基准报道触发追买；更合理的是把它作为平台化溢价的一条验证线：若后续在财报/客户案例中看到系统级收入、网络/系统占比提升或企业 AI 工厂部署加速，则提高平台化权重；否则将其视作宣传噪声降权。"
        },
        {
          "target": "跟踪重点与风险",
          "fields": [
          ...
          "suggestion": "跟踪 Vera CPU 的量产/上市时间、目标服务器平台与 OEM/云端采用路径（是否进入机架级 AI 工厂方案）。；等待更完整第三方基准与真实工作负载评测：性能/功耗/TCO 与 x86/Arm 竞品对比、内存带宽在真实智能体工作流中的收益。；观察 NVIDIA 后续是否把 Vera 与网络/系统（NVLink、Spectrum-X、InfiniBand）与软件编排绑定定价与交付，验证其是否能转化为系统级收入与更高平台粘性。"
        }
      ],
      "writeback_plan": [
        {
          "section": "当前结论",
          "plan": "用「Vera CPU 初步基准披露：88 核 + 1.2TB/s 内存带宽，瞄准智能体 AI 工厂的 CPU 瓶颈与能效」更新最新事件；当前结论只写这条事件对主线判断的增量，不覆盖长期判断底稿。"
        },
        {
          "section": "公司理解",
          "plan": "业务层面，Vera CPU 的意义不在于单独卖 CPU，而在于补齐“GPU + CPU + 网络 + 软件编排”的系统方案：智能体工作流往往包含大量 CPU 密集型任务（代码编译/运行时执行/数据压缩/数据库查询/系统协调），这些环节若成为瓶颈，会限制整套 AI 工厂的端到端吞吐与利用率。若 Vera 以 Arm 生态进入 OEM/整机方案（与 NVLink/网络/软件栈协同），则会提升 NVIDIA 在企业本地部署与云厂商平台中的系统粘性。"
        },
        {
          "section": "财务数据地图",
          "plan": "提取收入、利润率、现金流、订单、backlog、capex、应收或存货等可核验数字，写成财务地图的增量注释。"
        ...
        {
          "section": "估值模型",
          "plan": "估值/动作上，Vera 目前仍属于“路线图兑现前”的材料：正面在于给出了可量化的规格与能效口径（88 核、1.2TB/s、功耗结构），并获得第三方媒体初步背书；限制在于量产时间、供给、真实 TCO/性能/兼容性与客户采用尚未验证。动作上不应因单篇基准报道触发追买；更合理的是把它作为平台化溢价的一条验证线：若后续在财报/客户案例中看到系统级收入、网络/系统占比提升或企业 AI 工厂部署加速，则提高平台化权重；否则将其视作宣传噪声降权。"
        },
        {
          "section": "跟踪重点与风险",
          "plan": "跟踪 Vera CPU 的量产/上市时间、目标服务器平台与 OEM/云端采用路径（是否进入机架级 AI 工厂方案）。；等待更完整第三方基准与真实工作负载评测：性能/功耗/TCO 与 x86/Arm 竞品对比、内存带宽在真实智能体工作流中的收益。；观察 NVIDIA 后续是否把 Vera 与网络/系统（NVLink、Spectrum-X、InfiniBand）与软件编排绑定定价与交付，验证其是否能转化为系统级收入与更高平台粘性。"
        }
      ],
      "reason": "这条事件的增量在于：NVIDIA 正在把“AI 工厂”的全栈边界扩到 CPU，并用“智能体工作负载需要更强 CPU + 更高内存带宽/能效”的口径解释其必要性。它不直接带来短期财务数字，但如果 Vera 能在企业/云端 AI 工厂部署里成为标准配置，将增强 NVIDIA 在系统级销售中的话语权，并把更多价值从单点 GPU 延伸到 CPU/平台能效与编排。",
      "valuation_impact": "估值/动作上，Vera 目前仍属于“路线图兑现前”的材料：正面在于给出了可量化的规格与能效口径（88 核、1.2TB/s、功耗结构），并获得第三方媒体初步背书；限制在于量产时间、供给、真实 TCO/性能/兼容性与客户采用尚未验证。动作上不应因单篇基准报道触发追买；更合理的是把它作为平台化溢价的一条验证线：若后续在财报/客户案例中看到系统级收入、网络/系统占比提升或企业 AI 工厂部署加速，则提高平台化权重；否则将其视作宣传噪声降权。",
      "next_verification": [
