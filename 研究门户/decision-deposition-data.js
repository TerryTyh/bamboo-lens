window.BAMBOO_LENS_DECISION_DEPOSITION = {
  ...
  "source_decision_impact_at": "2026-06-12T10:41:00",
  "items": [
    {
      "company": "tsmc",
      "company_name": "TSMC",
    ...
    },
    {
      ...
      "company_name": "NVIDIA",
      "event_index": 0,
      "event_title": "Apple Intelligence 私有云开始采用 Blackwell 机密计算，NVIDIA 切入高隐私推理基础设施",
      ...
      "recommended_updates": [
        {
          ...
          "suggestion": "把最新事件更新为「Apple Intelligence 私有云开始采用 Blackwell 机密计算，NVIDIA 切入高隐私推理基础设施」；业务影响写入：业务上，这条事件同时验证了三件事。第一，Blackwell 的落地场景从超大模型训练扩展到消费级智能助手的服务端推理，说明推理需求曲线正在向更广泛终端生态渗透。第二，机密计算不再只是安全功能展示，而是成为大型客户把敏感 AI 负载放上外部云的前提条件，这会提高 GPU、系统软件与云合作方案的整体附加率。第三，Apple、Google、NVIDIA 的组合说明 NVIDIA 正在参与“模型提供方 + 云基础设施 + 安全执行环境”这一整套交付链，而不只是底层芯片供应商。；估值/动作"
        },
        {
          "target": "公司理解",
          "fields": [
          ...
          "suggestion": "业务上，这条事件同时验证了三件事。第一，Blackwell 的落地场景从超大模型训练扩展到消费级智能助手的服务端推理，说明推理需求曲线正在向更广泛终端生态渗透。第二，机密计算不再只是安全功能展示，而是成为大型客户把敏感 AI 负载放上外部云的前提条件，这会提高 GPU、系统软件与云合作方案的整体附加率。第三，Apple、Google、NVIDIA 的组合说明 NVIDIA 正在参与“模型提供方 + 云基础设施 + 安全执行环境”这一整套交付链，而不只是底层芯片供应商。"
        },
        {
          "target": "财务数据地图",
          "fields": [
        ...
        },
        {
          ...
          "suggestion": "估值和动作上，这条事件支持继续给予 NVIDIA 平台溢价，因为它把市场对公司的需求来源进一步扩展到高隐私推理和可信 AI 基础设施。正面在于原文给出了 Apple Private Cloud Compute、Google Cloud、Blackwell 和机密计算这几个非常具体的落地抓手，说明机密计算开始进入真实生产场景。限制在于文章没有披露 GPU 数量、合同金额、推理规模或软件收入贡献，因此不足以单独上调短期盈利预测。动作上维持 A 池核心，并把机密计算渗透率、服务端推理负载和大型平台客户采用情况列为新增验证主线。"
        },
        {
          "target": "跟踪重点与风险",
          "fields": [
          ...
          "suggestion": "跟踪 Apple 后续是否披露 Private Cloud Compute 在 Google Cloud 上的推理规模、覆盖功能范围和上线节奏，确认这不是局部试点。；观察 NVIDIA 财报或电话会是否开始单独提及机密计算、私密推理或高隐私推理场景的客户需求。；继续看 Google Cloud 是否围绕 Blackwell 机密计算推出更明确的产品化口径、客户案例或定价模式。"
        }
      ],
      "writeback_plan": [
        {
          "section": "当前结论",
          "plan": "用「Apple Intelligence 私有云开始采用 Blackwell 机密计算，NVIDIA 切入高隐私推理基础设施」更新最新事件；当前结论只写这条事件对主线判断的增量，不覆盖长期判断底稿。"
        },
        {
          "section": "公司理解",
          "plan": "业务上，这条事件同时验证了三件事。第一，Blackwell 的落地场景从超大模型训练扩展到消费级智能助手的服务端推理，说明推理需求曲线正在向更广泛终端生态渗透。第二，机密计算不再只是安全功能展示，而是成为大型客户把敏感 AI 负载放上外部云的前提条件，这会提高 GPU、系统软件与云合作方案的整体附加率。第三，Apple、Google、NVIDIA 的组合说明 NVIDIA 正在参与“模型提供方 + 云基础设施 + 安全执行环境”这一整套交付链，而不只是底层芯片供应商。"
        },
        {
          "section": "财务数据地图",
          "plan": "提取收入、利润率、现金流、订单、backlog、capex、应收或存货等可核验数字，写成财务地图的增量注释。"
        ...
        {
          "section": "估值模型",
          "plan": "估值和动作上，这条事件支持继续给予 NVIDIA 平台溢价，因为它把市场对公司的需求来源进一步扩展到高隐私推理和可信 AI 基础设施。正面在于原文给出了 Apple Private Cloud Compute、Google Cloud、Blackwell 和机密计算这几个非常具体的落地抓手，说明机密计算开始进入真实生产场景。限制在于文章没有披露 GPU 数量、合同金额、推理规模或软件收入贡献，因此不足以单独上调短期盈利预测。动作上维持 A 池核心，并把机密计算渗透率、服务端推理负载和大型平台客户采用情况列为新增验证主线。"
        },
        {
          "section": "跟踪重点与风险",
          "plan": "跟踪 Apple 后续是否披露 Private Cloud Compute 在 Google Cloud 上的推理规模、覆盖功能范围和上线节奏，确认这不是局部试点。；观察 NVIDIA 财报或电话会是否开始单独提及机密计算、私密推理或高隐私推理场景的客户需求。；继续看 Google Cloud 是否围绕 Blackwell 机密计算推出更明确的产品化口径、客户案例或定价模式。"
        }
      ],
      "reason": "这是一条 P1 级平台渗透事件。关键变化不是 Apple 又采购了一批 GPU，而是 NVIDIA 的 Blackwell 机密计算能力被放进 Apple Intelligence 的私有云安全架构，并通过 Google Cloud 承接外部推理负载。它说明 NVIDIA 正在把自身价值从高性能训练和通用推理，延伸到高隐私、高信任要求的 AI 服务基础设施层",
      "valuation_impact": "估值和动作上，这条事件支持继续给予 NVIDIA 平台溢价，因为它把市场对公司的需求来源进一步扩展到高隐私推理和可信 AI 基础设施。正面在于原文给出了 Apple Private Cloud Compute、Google Cloud、Blackwell 和机密计算这几个非常具体的落地抓手，说明机密计算开始进入真实生产场景。限制在于文章没有披露 GPU 数量、合同金额、推理规模或软件收入贡献，因此不足以单独上调短期盈利预测。动作上维持 A 池核心，并把机密计算渗透率、服务端推",
      "next_verification": [
