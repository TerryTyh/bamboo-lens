      ...
      "events": [
        {
          ...
          "fetched_at": "",
          "type": "客户 / 机密计算 / 云推理",
          "fact": "2026-06-09，NVIDIA 官方披露，带机密计算能力的 NVIDIA GPU 已用于 Apple Private Cloud Compute 的机密推理场景；随着 PCC 从 Apple 自有数据中心扩展到 Google Cloud，NVIDIA Blackwell GPU 将支撑 Apple Foundation Models 的服务端推理，并服务于下一代 Apple Intelligence 功能。文章同时说明，NVIDIA 机密计算通过可信执行环境和加密校验来保护推理过程中的数据、对话与请求内容。",
          "judgment": "这是一条 P2 级正式事件。它改变的不是 NVIDIA 当季收入预期，而是市场对其“安全推理基础设施”能力的认知边界。过去市场更容易把 NVIDIA 估值建立在训练集群、超大云厂商资本开支和 AI 工厂平台上；这条信息补了一层更细的生产级场景验证: 当生成式 AI 进入高隐私、强合规、面向消费端大规模用户的服务端推理时，NVIDIA 也在切入底层执行层。没有变化的是，文章没有披露订单规模、GPU 数量、收入贡献或 attach rate，因此还不足以单独上调盈利预测或仓位动作。",
          ...
          "evidence": [
            "文章明确写到，NVIDIA GPUs with Confidential Computing 已被用于 Apple Private Cloud Compute 的 confidential inference。",
            "PCC 的部署范围已从 Apple 自有数据中心扩展到 Google Cloud，说明这不是实验室演示，而是跨云基础设施的实际扩容场景。",
            "底层硬件被点名为 NVIDIA Blackwell GPUs，并嵌入 PCC 的硬件安全架构，用于 Apple Foundation Models 的服务端推理。",
            "原文解释机密计算通过 trusted execution environments 隔离工作负载，并在敏感数据发送前做 cryptographic verification，说明卖点落在可验证的推理安全机制，而不是抽象品牌宣传。",
            "合作方同时包括 Apple 与 Google，表明 NVIDIA 在高隐私云推理链条里拿到了头部平台客户的联合参考案例。"
          ],
          "business_analysis": "业务上，这条事件把 NVIDIA 的平台边界从训练与通用推理，进一步延伸到“高隐私推理基础设施”。Apple Private Cloud Compute 的核心约束不是纯算力，而是用户数据在云端推理时能否被隔离、验证和可信执行；NVIDIA 机密计算能进入这层，说明其价值不只在 GPU 吞吐，还在与云平台、模型服务和安全架构协同的生产级能力。对 NVIDIA 来说，这类场景如果持续扩散到消费 AI、企业私有推理和 regulated AI workloads，可能提升 Blackwell 在服务端推理市场的黏性，并强化 GPU + 安全执行环境的一体化卖点。",
          "valuation_analysis": "估值/动作上，这更像高质量的能力强化信号，而不是立刻加仓的财务催化剂。正面在于，Apple + Google 的联合落地让 NVIDIA 机密计算从概念走到真实客户场景，有助于支撑其在推理时代继续维持平台溢价；约束在于，当前没有量化数据，无法判断这会带来多大规模的 GPU 出货、软件附加率或毛利改善。动作上维持核心跟踪，不因单条合作新闻追价；但后续如果更多云平台、企业 AI 或消费端 AI 服务把机密计算列为标准配置，NVIDIA 的推理估值框架应上调对“安全执行层”贡献的权重。",
          "verification": [
            ...
            "验证 Blackwell 在推理侧的安全能力，是否能转化为更高的 attach rate、软件收入或更稳固的推理平台份额。"
          ],
          "reviewed_at": "2026-06-17T00:30:00",
        ...
        },
        {
          ...
          "priority": "P1",
          "sort_key": 20260331,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/1435/一个财务投资应用/长期高潜力公司跟踪系统/28-NVIDIA动态更新样例V1.md"
        },
        {
    ...
    "tsmc": {
      ...
      "events": [
        ...
        },
        {
          ...
          "priority": "P1",
          "sort_key": 20260416,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/1435/一个财务投资应用/长期高潜力公司跟踪系统/25-TSMC动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260429,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/1435/一个财务投资应用/长期高潜力公司跟踪系统/24-Microsoft动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260319,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/1435/一个财务投资应用/长期高潜力公司跟踪系统/20-阿里巴巴动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P2",
          "sort_key": 20260107,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/1435/一个财务投资应用/长期高潜力公司跟踪系统/23-汇川技术动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260422,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/1435/一个财务投资应用/长期高潜力公司跟踪系统/26-GE Vernova动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P2",
          "sort_key": 20260419,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/1435/一个财务投资应用/长期高潜力公司跟踪系统/18-立讯精密动态更新样例V1.md"
        },
        {
    ...
    "constellation": {
      ...
      "events": [
        ...
        },
        {
          ...
          "priority": "P2",
          "sort_key": 20260318,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/1435/一个财务投资应用/长期高潜力公司跟踪系统/27-Constellation Energy动态更新样例V1.md"
        },
        {
