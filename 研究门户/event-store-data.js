    ...
    "nvidia": {
      ...
      "events": [
        ...
        },
        {
          ...
          "priority": "P1",
          "sort_key": 20260331,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/09a1/一个财务投资应用/长期高潜力公司跟踪系统/28-NVIDIA动态更新样例V1.md"
        },
        {
      ...
      "official_candidates": [
        {
          ...
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/nvidia__20260514-133033__investor.nvidia.com_news_press-releases_default.aspx.html",
          "content_summary": [
            "文章宣布《Subnautica 2》在发售时点（day-and-date）同步上线 GeForce NOW，主打“几乎任意设备即开即玩”，无需预装与下载。",
        ...
        },
        {
          ...
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/nvidia__20260514-133033__investor.nvidia.com_news_press-releases_default.aspx.html",
          "content_summary": [
            "文章介绍 Nous Research 开源的 Hermes Agent：定位“可靠、可自我改进”的 agentic 框架，并声称其在不到三个月获得 14 万 GitHub stars，且按 OpenRouter 统计为“最常用的 agent”。",
            "Hermes 设计为 provider / model agnostic，并强调适合“always-on 的本地运行”，可以集成消息应用、访问本地文件与应用，支持 24/7 持续工作。",
            "文中把 Alibaba 的 Qwen 3.6 27B/35B 开源权重模型作为本地 agent 的适配模型：声称 35B 约 20GB 显存即可运行，同时性能超过上一代 120B/400B 级模型；27B 作为 dense 模型给出“接近 400B 级准确度但体量显著更小”的表述。",
            "NVIDIA 侧的叙述重点是“硬件决定体验”：以 RTX GPU 的 Tensor Cores 作为加速基础，强调吞吐与时延改善，适配多步任务与持续运行的 agent 工作负载。",
            "文章同时推介 DGX Spark 作为持续运行 agent 的小型机：文中给出 128GB unified memory、1 petaflop AI performance，可“全天运行”更大规模模型的描述，并配套 playbook/动手课程引导。",
            "对业务理解的增量在于：NVIDIA 正把“本地 agent”作为 RTX AI PC / 小型工作站的新使用场景来讲故事，目标是把 agent 从云端推到端侧并绑定其 GPU/整机生态；短期更偏生态与需求叙事，是否转化为可见营收需后续出货与采用数据验证。"
          ]
        },
        {
          "title": "NVIDIA, Ineffable Intelligence Team Up to Build the Future of Reinforcement Learning Infrastructure",
          ...
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/nvidia__20260514-133033__investor.nvidia.com_news_press-releases_default.aspx.html",
          "content_summary": [
            "文章宣布 NVIDIA 与 Ineffable Intelligence（由 AlphaGo 架构师 David Silver 创立、伦敦的 AI 实验室）开展工程层面的合作，目标是共同设计可在大规模上支撑强化学习（reinforcement learning）的基础设施/训练流水线。",
            "文中引用 Jensen Huang 的表述，把“superlearners（从经验中持续学习的系统）”定义为 AI 的下一前沿，并称合作将共同设计面向大规模 RL 的基础设施。",
            "文章也引用 David Silver 的观点：预训练更多是“学习人类已有知识”，而更难的问题是让系统通过经验发现新知识，因此需要不同于预训练的数据与训练范式。",
            "文章解释 RL 与预训练的系统差异：RL 工作负载需要在紧密循环中持续“行动-观察-评分-更新”，数据在线生成，对互联、带宽、内存与服务（serving）链路提出不同压力。",
            "合作的工程工作据文中描述从 NVIDIA Grace Blackwell 平台起步，并将成为较早探索未来 NVIDIA Vera Rubin 平台的项目之一。",
            "对业务理解的增量是：NVIDIA 试图提前把“后训练/强化学习/模拟环境学习”这一类下一代训练负载与其新平台（Grace Blackwell、Vera Rubin）绑定，通过前沿实验室合作提前定义软硬件栈；但该类合作本身更像研发/生态信号，商业化节奏与收入贡献仍需等待后续披露与客户采用验证。"
          ]
        },
        {
          ...
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/nvidia__20260514-133033__investor.nvidia.com_news_press-releases_default.aspx.html",
          "content_summary": [
            "文章围绕企业场景的“专用 AI agents”展开，强调这类 agent 正进入财务、采购、供应链、制造等企业系统，直接触达业务决策与工作流。",
            "文中提到在 SAP Sapphire 场景下，SAP 与 NVIDIA 扩大合作，目标是帮助企业在 SAP Business AI Platform 上运行专用 agent（文中以“可规模化运行”描述）。",
            "文章把“信任/可控”作为企业 agent 的关键门槛：强调需要隔离执行、治理与控制，以满足企业安全与合规约束。",
            "NVIDIA 的叙述定位是把 OpenShell 作为企业 agent 栈的运行时与治理层能力，与上层业务平台（SAP）形成集成关系。",
            "从信息结构看，这是一条生态合作与产品能力声明，核心增量是明确“企业落地的关键痛点是执行隔离与治理控制”。",
            "对业务与估值影响需要后续用客户采用规模、SAP 平台绑定深度、以及是否带动企业 GPU/软件订阅与交付来验证。"
          ]
        },
        {
    ...
    "tsmc": {
      ...
      "events": [
        ...
        },
        {
          ...
          "priority": "P1",
          "sort_key": 20260416,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/09a1/一个财务投资应用/长期高潜力公司跟踪系统/25-TSMC动态更新样例V1.md"
        },
        {
      ...
      "official_candidates": [
        {
          ...
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/tsmc__20260514-133033__pr.tsmc.com_english_latest-news.html",
          "content_summary": [
            "公告列出董事会通过的决议事项，核心包括：确认 2026Q1 财报数字、决定季度现金股利、核准新增资本支出拨款与对 Arizona 子公司注资上限。",
            "财报数字方面披露：2026Q1 合并营收 NT$1,134.10 billion、净利润 NT$572.48 billion、稀释 EPS NT$22.08。",
            "股东回报方面：核准 2026Q1 每股现金股利 NT$7.0，并给出普通股/ADS 的除息日、登记日与预计发放日安排。",
            "资本配置方面：核准约 US$31,284.30 million 的资本支出拨款，用途指向先进技术产能及厂房/厂务系统等；并核准对 TSMC Arizona 注资不超过 US$20 billion。",
            "这条公告的增量主要在资本开支与海外扩产资金承诺的口径更新，而非单独“Q1 业绩”数字本身。",
            "对投资理解上更像“资本回报与海外扩产风险”的跟踪节点：后续需要用毛利率、现金流与海外产线爬坡进度来验证高强度 capex 的回报质量。"
          ]
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260429,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/09a1/一个财务投资应用/长期高潜力公司跟踪系统/24-Microsoft动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260319,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/09a1/一个财务投资应用/长期高潜力公司跟踪系统/20-阿里巴巴动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P2",
          "sort_key": 20260107,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/09a1/一个财务投资应用/长期高潜力公司跟踪系统/23-汇川技术动态更新样例V1.md"
        },
        {
      ...
      "official_candidates": [
        {
          ...
          "source_excerpt": "",
          "source_body": "",
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/inovance__20260514-133033__www.inovance.com_portal-front_api_product_launch_listPage_pageNum_1_pageSize_10.html"
        },
        {
          "title": "2025年度爆品发布会",
          "date": "2025-09-01",
        ...
        },
        {
          ...
          "source_excerpt": "",
          "source_body": "",
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/inovance__20260514-133033__www.inovance.com_portal-front_api_home_search_key_%E6%96%B0%E5%93%81_showChannel_2.html"
        },
        {
        ...
        },
        {
          ...
          "source_excerpt": "",
          "source_body": "",
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/inovance__20260514-133033__www.inovance.com_portal-front_api_home_search_key_%E6%9C%BA%E5%99%A8%E4%BA%BA_showChannel_2.html"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260422,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/09a1/一个财务投资应用/长期高潜力公司跟踪系统/26-GE Vernova动态更新样例V1.md"
        },
        {
      ...
      "official_candidates": [
        {
          ...
          "source_excerpt": "",
          "source_body": "",
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/gevernova__20260514-133033__www.gevernova.com_investors_events.html"
        }
      ]
    },
    "luxshare": {
      ...
      "events": [
        {
          ...
          "priority": "P2",
          "sort_key": 20260419,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/09a1/一个财务投资应用/长期高潜力公司跟踪系统/18-立讯精密动态更新样例V1.md"
        },
        {
      ...
      "official_candidates": [
        {
          ...
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/luxshare__20260514-133033__www.luxshare-ict.com_en_news_release.html.html"
        },
        {
    ...
    "constellation": {
      ...
      "events": [
        ...
        },
        {
          ...
          "priority": "P2",
          "sort_key": 20260318,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/09a1/一个财务投资应用/长期高潜力公司跟踪系统/27-Constellation Energy动态更新样例V1.md"
        },
        {
      ...
      "official_candidates": [
        {
          ...
          "source_body": "",
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/constellation__20260514-133033__www.constellationenergy.com_newsroom.html.html"
        },
        {
        ...
        },
        {
          ...
          "source_excerpt": "",
          "source_body": "",
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/constellation__20260514-133033__investors.constellationenergy.com_events-and-presentations_past-events.html"
        },
        {
