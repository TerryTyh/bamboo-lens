    ...
    "nvidia": {
      ...
      "events": [
        ...
        },
        {
          ...
          "source_candidate_title": "Vera Arrives: NVIDIA’s First CPU Built for Agents Lands at Top AI Labs",
          "date": "2026-05-18",
          "fetched_at": "",
          "type": "产品 / CPU / Agentic AI",
          "fact": "2026-05-18，NVIDIA 在官方博客披露 Vera（公司首款自研 CPU）已完成首批对外交付：交付对象包括 Anthropic、OpenAI、SpaceXAI 以及 Oracle Cloud Infrastructure。原文描述 Vera 面向 agentic AI 的并发、实时 CPU 任务场景，并给出 88 核 Olympus、1.2TB/s 内存带宽与“每核性能快 50%”等参数口径。",
          "judgment": "这条事件的增量不在短期财务数字，而在 NVIDIA 明确把“AI 工厂平台”从 GPU/网络继续向 CPU 延伸：它把智能体执行与编排层的关键瓶颈（CPU 侧并发与确定性性能）纳入自家平台路线。现阶段应把它视为平台化与产品化的信号，而不是已经兑现的收入拐点：交付对象是头部实验室与云厂商，代表生态验证开始，但仍需要看到 OEM/云规模化上架与真实采购节奏。",
          "action": "维持 A 池核心；把 CPU 扩张与 agentic AI 平台化兑现列为新增验证点",
          "priority": "P2",
          "sort_key": 20260518,
          ...
          "source_summary": [
            ...
            "文章将 Vera 的定位描述为“为 agentic AI 时代定制的 CPU”：其关键工作负载不是 GPU 的矩阵计算，而是智能体沙箱、工具调用、编排层与长上下文检索等大量并发、实时的 CPU 侧任务。",
            "文中给出 Vera 的核心规格与口径：88 个 NVIDIA 自研 Olympus 核心、1.2TB/s 内存带宽、每核性能较传统方案快 50%；并援引 Anthropic 负责人观点，强调扩展算力对模型迭代的重要性。"
          ],
          "evidence": [
            "交付事实：首批 Vera CPU 交付 Anthropic、OpenAI、SpaceXAI，随后交付 Oracle Cloud Infrastructure（均为原文点名）。",
            "业务定位：文章称 Jensen Huang 在 3 月 GTC San Jose 将 Vera 介绍为 NVIDIA 下一条“multibillion dollar business”。",
            "规格口径：Vera 采用 88 个自研 Olympus cores，宣称 1.2TB/s 内存带宽，并称每核性能较传统方案快 50%。",
            "工作负载口径：原文强调 agentic sandbox、tool call、orchestration layer、long-context retrieval 等大量 CPU 侧并发任务是设计出发点。",
            "第三方表述：文章引用 Anthropic head of compute 观点，强调 scaling compute 对模型增长的重要性，并称期待 Vera 成为 agentic workloads 生态的一部分。"
          ],
          "business_analysis": "对业务层面，Vera 的价值在于提高 NVIDIA 在 AI 工厂“全栈控制面”的嵌入度：智能体编排、工具沙箱、检索与数据管道等 CPU 密集环节若能与 GPU/互连/系统一起打包销售，有机会提升机架级系统的整机份额与客户切换成本。与此同时，CPU 是传统强竞争市场，真正影响经营要看是否进入主流服务器平台（OEM 上架、云实例化）以及与既有 GPU 平台形成可规模复制的联合方案。",
          "valuation_analysis": "估值/动作上，这更偏“平台溢价验证”而非短线催化：正面是平台边界扩展与头部客户试用开启，有助于支撑对 NVIDIA 长期 TAM 与生态粘性的更高权重；约束是 CPU 业务的量产节奏、毛利结构与与既有 CPU 生态的竞争强度尚未披露。动作建议维持核心持仓/研究优先级不变，把 Vera 的规模化上架与与机架级系统绑定销售作为后续验证点，避免仅凭发布与首批交付上调短期盈利假设。",
          "verification": [
          ...
          "reviewed_at": "2026-05-27T22:37:28+08:00",
          "review_status": "reviewed"
        },
        {
          "title": "Dell AI Factory with NVIDIA：Rubin NVL72/XE9812 与 HGX Rubin NVL8 上线，宣称推理 cost/token 最高降 10x、144 GPU/rack",
          "source_candidate_title": "NVIDIA CEO Jensen Huang at Dell Technologies World: ‘Demand Is Going Parabolic, Utterly Parabolic’",
          "date": "2026-05-18",
          "fetched_at": "",
          "type": "企业 AI 工厂 / 服务器平台 / 推理成本",
          "fact": "2026-05-18，NVIDIA 在官方博客披露并宣传 Dell AI Factory with NVIDIA 的一组新品与口径：包括基于 Vera Rubin NVL72 的 Dell PowerEdge XE9812（宣称相对 Blackwell 最高 10 倍更低 cost-per-token），以及基于 HGX Rubin NVL8 的 XE9880L/XE9885L/XE9882L（宣称每机架最高 144 GPU、100% 直冷、相对 HGX B200 最高 10 倍性能）。文中亦提及 Quantum-X800 InfiniBand/Spectrum-6 Ethernet 的交换机组合与 Dell PowerRack，并称 M9822/R9822 将引入 Vera CPU。",
          "judgment": "这条事件的核心不是“演讲式口号”，而是企业侧 AI 工厂产品化的两层信号：第一，Rubin 平台正通过 OEM（Dell）把机架级系统、网络与整机一体化（PowerRack）打包到企业私域部署场景；第二，文中用 cost-per-token、GPU/rack、液冷等可工程化指标描述部署形态，显示竞争焦点从单卡性能转向“系统吞吐/能耗/集成成本”。但需要注意：文中大量为厂商宣称与对比口径，不能直接等同于可验证的真实 TCO；对投资判断的关键在于 Rubin 的供给节奏与企业侧交付规模是否会在后续季度体现为系统/网络/软件的更高占比与更强粘性。",
          "action": "维持 A 池核心；把企业侧 AI 工厂交付与 Rubin 供给节奏纳入下一阶段验证",
          "priority": "P2",
          "sort_key": 20260518,
          "source_url": "https://blogs.nvidia.com/blog/dell-technologies-agent-enterprise-ai/",
          "source_doc": "云端研究简报系统/outputs/official_candidates.json",
          "source_summary": [
            "NVIDIA 官方博客围绕 Dell Technologies World 的企业侧“Dell AI Factory with NVIDIA”叙事，强调企业 AI 从试点走向 agentic AI 与大规模推理部署，并给出多项与 Rubin 平台相关的新品口径。",
            "文章称 Dell PowerEdge XE9812（基于 NVIDIA Vera Rubin NVL72）面向大规模 agentic AI 推理，宣称相对 NVIDIA Blackwell 可实现“最高 10 倍更低 cost-per-token”；并称 XE9880L/XE9885L/XE9882L 为首批基于 NVIDIA HGX Rubin NVL8 的 Dell 系统，支持每机架最高 144 GPU、100% 直冷节点，并宣称相对 HGX B200 最高 10 倍性能。",
            "文章同时提到网络侧的 Dell PowerSwitch + NVIDIA Quantum-X800 InfiniBand、Spectrum-6 Ethernet，以及整机一体化的 Dell PowerRack；在 CPU 侧，Dell PowerEdge M9822/R9822 将引入 Vera CPU，并给出“1.2TB/s 内存带宽、agentic workloads 50% 更快”等口径。"
          ],
          "evidence": [
            "推理成本口径：文章称 XE9812（Vera Rubin NVL72）可实现“最高 10 倍更低 cost-per-token”，对比对象为 NVIDIA Blackwell。",
            "系统形态口径：文章称 XE9880L/XE9885L/XE9882L 为首批基于 NVIDIA HGX Rubin NVL8 的 Dell 系统，支持每机架最高 144 GPU，且为 100% direct liquid-cooled compute nodes。",
            "性能对比口径：文章称上述 HGX Rubin NVL8 系统“最高 10 倍性能”相对 HGX B200。",
            "企业采用口径：文章称约 5,000 家企业（举例 Lilly、Samsung、Honeywell）在 Dell AI Factories with NVIDIA 上运行 AI 工作负载。",
            "宏观口径：文章引用 Dell 观点，称到 2030 年全球 AI 基础设施支出或达 3-4 万亿美元、token 消耗或增长 3,400%。",
            "CPU 侧口径：文章称 Vera CPU 1.2TB/s 内存带宽，并称 agentic workloads 相对 x86 “50% 更快”，企业数据查询“最高 3 倍更快”。"
          ],
          "business_analysis": "对业务层面，这条动态强化了 NVIDIA 的“AI 工厂平台”在企业私域市场的落地路径：通过 Dell 这样的 OEM，把 GPU（Rubin）、网络（InfiniBand/Ethernet）与整机系统（PowerRack）作为可交付单元进入企业数据中心。这有助于 NVIDIA 把增长从云厂商 capex 扩展到更分散但规模巨大的企业侧推理与 agentic 部署市场；同时，OEM/系统层的推进也可能提升网络与系统级产品的绑定率，形成更高的每机架收入与更强的方案锁定效应。",
          "valuation_analysis": "估值/动作上，这类“企业侧产品化”信息更多影响确信度与中长期渗透率假设：正面是它支持平台化溢价（系统/网络/软件协同）而非纯芯片周期；约束是口径多为发布会宣称，短期兑现仍取决于 Rubin 量产与交付、企业预算释放与项目扩散速度。动作建议维持核心跟踪，避免把发布会对比直接外推为短期毛利或收入加速；把验证重点放到 OEM 订单/交付、企业侧推理需求可见性，以及网络/系统收入占比是否继续抬升。",
          "verification": [
        ...
        },
        {
          ...
          "priority": "P1",
          "sort_key": 20260331,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/2cf2/一个财务投资应用/长期高潜力公司跟踪系统/28-NVIDIA动态更新样例V1.md"
        },
        {
    ...
    "tsmc": {
      ...
      "events": [
        ...
        },
        {
          ...
          "priority": "P1",
          "sort_key": 20260416,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/2cf2/一个财务投资应用/长期高潜力公司跟踪系统/25-TSMC动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260429,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/2cf2/一个财务投资应用/长期高潜力公司跟踪系统/24-Microsoft动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260319,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/2cf2/一个财务投资应用/长期高潜力公司跟踪系统/20-阿里巴巴动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P2",
          "sort_key": 20260107,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/2cf2/一个财务投资应用/长期高潜力公司跟踪系统/23-汇川技术动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260422,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/2cf2/一个财务投资应用/长期高潜力公司跟踪系统/26-GE Vernova动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P2",
          "sort_key": 20260419,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/2cf2/一个财务投资应用/长期高潜力公司跟踪系统/18-立讯精密动态更新样例V1.md"
        },
        {
    ...
    "constellation": {
      ...
      "events": [
        ...
        },
        {
          ...
          "priority": "P2",
          "sort_key": 20260318,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/2cf2/一个财务投资应用/长期高潜力公司跟踪系统/27-Constellation Energy动态更新样例V1.md"
        },
        {
