    ...
    "nvidia": {
      ...
      "events": [
        {
          ...
          "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/nvidia__20260529-144007__investor.nvidia.com_news_press-releases_default.aspx.html",
          "source_summary": [
          ...
          "evidence": [
            "单位经济口径：用 tokens/s、tokens/W、每 token 成本、利用率、在线率（uptime）定义 AI 工厂经营效率，而不是仅以训练规模/峰值算力描述能力。",
            "负载变化口径：强调“持续推理 + 智能体/多智能体工作流”使推理链条更长、更深、更依赖端到端编排与协同，导致基础设施瓶颈从单点算力转向全栈吞吐与时延。",
            "全栈范围口径：把模型、算力、网络、内存、软件、存储、电力与散热作为同一系统优化对象，并把 CPU 执行/编排、网络协调与上下文存储写入“必须项”。"
          ],
          "business_analysis": "业务层面，这条框架把 NVIDIA 的竞争边界从“卖 GPU”推进到“卖 AI 工厂的全栈产能与效率”：推理/智能体负载要求 GPU 之外还要网络、存储/内存层级、编排软件与 CPU 执行协同，天然有利于 NVIDIA 用平台方式打包（计算+网络+软件）并提升系统级粘性。对客户侧，它也把讨论从“买多少卡”转为“单位能耗产出多少 tokens、每 token 成本是多少、系统上线率/利用率如何”，会影响云厂商/企业对基础设施选型与优化的 KPI。",
          "valuation_analysis": "估值/动作上，这条事件更像“解释为什么平台溢价可能持续”的材料，而不是短期交易触发。若后续产品/客户案例能持续把 tokens/W 与每 token 成本显著改善，并转化为更高利用率/更强定价或更高软件附加值，则支撑更高质量的收入与更稳定的毛利结构；反之若只是口号而无法被财报中的收入结构（网络/软件占比）、毛利率、供给与客户 capex 兑现验证，则应降低对平台化叙事的权重。动作上维持核心跟踪，优先把验证点落到“单位经济指标是否在客户侧可被观测”。",
          "verification": [
          ...
          "reviewed_at": "2026-06-01T22:33:30+08:00",
          "review_status": "reviewed"
        },
        {
          "title": "Vera CPU 初步基准披露：88 核 + 1.2TB/s 内存带宽，瞄准智能体 AI 工厂的 CPU 瓶颈与能效",
          "source_candidate_title": "NVIDIA Vera CPU Is ‘Packing a Heavy-Hitting Punch’ Against Competition",
          "date": "2026-05-26",
          "fetched_at": "",
          "type": "产品 / 路线图（数据中心 CPU）",
          "fact": "2026-05-26，NVIDIA 官方博客引用 Phoronix 的初步基准测试讨论 Vera CPU：面向智能体 AI 工厂的 CPU 负载（分支密集型运行时、沙箱代码执行、数据处理与编排），强调全核满载持续性能与高内存带宽/能效，披露 88 核 Olympus、1.2TB/s 带宽、450W TDP 与内存功耗 <30W 等口径。",
          "judgment": "这条事件的增量在于：NVIDIA 正在把“AI 工厂”的全栈边界扩到 CPU，并用“智能体工作负载需要更强 CPU + 更高内存带宽/能效”的口径解释其必要性。它不直接带来短期财务数字，但如果 Vera 能在企业/云端 AI 工厂部署里成为标准配置，将增强 NVIDIA 在系统级销售中的话语权，并把更多价值从单点 GPU 延伸到 CPU/平台能效与编排。",
          "action": "纳入公司页“业务理解/跟踪重点”：把 Vera CPU 作为 AI 工厂全栈（GPU+CPU+网络）的一条新增验证线",
          "priority": "P3",
          "sort_key": 20260526,
          ...
          "evidence": [
            "规格/定位：Vera CPU 采用 88 个 NVIDIA 自研 Olympus 核心（兼容 Armv9.2 ISA），针对智能体工作流中的分支密集型运行时、沙箱代码、数据处理与编排等 CPU 负载。",
            "带宽/能效：宣称 1.2TB/s 内存带宽；原文给出“内存功耗 <30W”的口径，并把 LPDDR5X 相对 DDR5 的能效优势作为卖点。",
            "第三方背书：引用 Phoronix 的基准测试结论与作者对“对 Intel/AMD x86_64 最强竞争”的评价，构成外部验证线索（但仍需等更完整测试与量产信息）。"
          ],
          "business_analysis": "业务层面，Vera CPU 的意义不在于单独卖 CPU，而在于补齐“GPU + CPU + 网络 + 软件编排”的系统方案：智能体工作流往往包含大量 CPU 密集型任务（代码编译/运行时执行/数据压缩/数据库查询/系统协调），这些环节若成为瓶颈，会限制整套 AI 工厂的端到端吞吐与利用率。若 Vera 以 Arm 生态进入 OEM/整机方案（与 NVLink/网络/软件栈协同），则会提升 NVIDIA 在企业本地部署与云厂商平台中的系统粘性。",
          "valuation_analysis": "估值/动作上，Vera 目前仍属于“路线图兑现前”的材料：正面在于给出了可量化的规格与能效口径（88 核、1.2TB/s、功耗结构），并获得第三方媒体初步背书；限制在于量产时间、供给、真实 TCO/性能/兼容性与客户采用尚未验证。动作上不应因单篇基准报道触发追买；更合理的是把它作为平台化溢价的一条验证线：若后续在财报/客户案例中看到系统级收入、网络/系统占比提升或企业 AI 工厂部署加速，则提高平台化权重；否则将其视作宣传噪声降权。",
          "verification": [
          ...
          "reviewed_at": "2026-06-01T22:35:30+08:00",
          "review_status": "reviewed"
        },
        {
        ...
        },
        {
          ...
          "priority": "P1",
          "sort_key": 20260331,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/370a/一个财务投资应用/长期高潜力公司跟踪系统/28-NVIDIA动态更新样例V1.md"
        },
        {
      ...
      "official_candidates": [
        ...
        },
        {
          ...
          "source_body": "The future of AI is landing in Taipei. At NVIDIA GTC Taipei at COMPUTEX, the world’s developers, researchers and industry leaders are converging to dive into the latest breakthroughs shaping every industry, covering topics spanning AI factories and scaling infrastructure to agentic and physical AI and more. Hear from NVIDIA founder and CEO Jensen Huang live on stage at Taipei Music Center on Monday, June 1, 11 a.m. Taipei time. Tune in early to catch the GTC Live at Taipei 2026 pregame show, featuring lively conversations with industry leaders about the latest innovations in AI and accelerated computing. This is the place to find all the latest — stay tuned to the blog for live updates. NVIDIA founder and CEO Jensen Huang gathered with MGX ecosystem partners to celebrate the companies helping build the AI factories that drive innovation across industries. “We’ve been working with all of our partners for quite some time to prepare for this new world where artificial intelligence will be everywhere, rather than just a computer,” Huang said. “Now AI has transformed the computer industry into infrastructure. Every company will be powered by artificial intelligence. Every country will have artificial intelligence that supports its society, its industry and its companies. And when it comes to what all the partners make possible Huang made it clear – NVIDIA can’t realize its dreams without them. “I want to thank all of you for your partnership,” Huang said. “I can’t do this without you, and together we are reinventing the computer industry – and we are reinventing the world.” Chemistry was the word to describe the unique gathering at the Brick Kiln restaurant in Taipei where NVIDIA founder and CEO Jensen Huang hosted more than 30 CEOs. Standing on a stool, Huang greeted his longtime partners with a toast and thanks for all the collaboration and hard work. Those present for the dinner lead the Taiwan supply chain companies that have helped to transform the tech industry and literally accelerate computing and AI. Huang moved from table to table chatting with his fellow CEOs and leaders. It was a casual evening filled with laughter and the deep relationships really showed. The night closed with Huang passing out treats to press and all the people, including families and children, who had filled the street outside the restaurant to see the fun. Wednesday evening in Taipei, Huang and his family dined with the Quanta Computer team, including founder and chairman Barry Lam and vice chairman and president C.C. Leung — celebrating years of partnership manufacturing the infrastructure of AI.",
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/nvidia__20260529-144007__investor.nvidia.com_news_press-releases_default.aspx.html"
        },
        {
    ...
    "tsmc": {
      ...
      "events": [
        ...
        },
        {
          ...
          "priority": "P1",
          "sort_key": 20260416,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/370a/一个财务投资应用/长期高潜力公司跟踪系统/25-TSMC动态更新样例V1.md"
        },
        {
      ...
      "official_candidates": [
        {
          ...
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/tsmc__20260529-144007__pr.tsmc.com_english_latest-news.html"
        }
      ]
    },
    "microsoft": {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260429,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/370a/一个财务投资应用/长期高潜力公司跟踪系统/24-Microsoft动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260319,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/370a/一个财务投资应用/长期高潜力公司跟踪系统/20-阿里巴巴动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P2",
          "sort_key": 20260107,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/370a/一个财务投资应用/长期高潜力公司跟踪系统/23-汇川技术动态更新样例V1.md"
        },
        {
      ...
      "official_candidates": [
        {
          ...
          "source_excerpt": "",
          "source_body": "",
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/inovance__20260529-144007__www.inovance.com_portal-front_api_product_launch_listPage_pageNum_1_pageSize_10.html"
        },
        {
          "title": "2025年度爆品发布会",
          "date": "2025-09-01",
        ...
        },
        {
          ...
          "source_excerpt": "",
          "source_body": "",
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/inovance__20260529-144007__www.inovance.com_portal-front_api_home_search_key_%E6%96%B0%E5%93%81_showChannel_2.html"
        },
        {
        ...
        },
        {
          ...
          "source_excerpt": "",
          "source_body": "",
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/inovance__20260529-144007__www.inovance.com_portal-front_api_home_search_key_%E6%9C%BA%E5%99%A8%E4%BA%BA_showChannel_2.html"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260422,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/370a/一个财务投资应用/长期高潜力公司跟踪系统/26-GE Vernova动态更新样例V1.md"
        },
        {
      ...
      "official_candidates": [
        {
          ...
          "source_excerpt": "",
          "source_body": "",
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/gevernova__20260529-144007__www.gevernova.com_investors_events.html"
        }
      ]
    },
    "luxshare": {
      ...
      "events": [
        {
          ...
          "priority": "P2",
          "sort_key": 20260419,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/370a/一个财务投资应用/长期高潜力公司跟踪系统/18-立讯精密动态更新样例V1.md"
        },
        {
      ...
      "official_candidates": [
        {
          ...
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/luxshare__20260529-144007__www.luxshare-ict.com_en_news_release.html.html"
        },
        {
    ...
    "constellation": {
      ...
      "events": [
        ...
        },
        {
          ...
          "priority": "P2",
          "sort_key": 20260318,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/370a/一个财务投资应用/长期高潜力公司跟踪系统/27-Constellation Energy动态更新样例V1.md"
        },
        {
      ...
      "official_candidates": [
        {
          ...
          "source_body": "",
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/constellation__20260529-144007__www.constellationenergy.com_newsroom.html.html"
        },
        {
        ...
        },
        {
          ...
          "source_excerpt": "",
          "source_body": "",
          "source_file": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/constellation__20260529-144007__investors.constellationenergy.com_events-and-presentations_past-events.html"
        },
        {
