      ...
      "events": [
        {
          ...
          "fetched_at": "",
          "type": "机密计算 / 云端推理基础设施",
          "fact": "2026-06-09，NVIDIA 披露其带机密计算能力的 GPU 已用于 Apple Private Cloud Compute 的 confidential inference。随着 PCC 从 Apple 自有数据中心扩展到 Google Cloud，NVIDIA 与 Apple、Google 协作，使用集成在 Google Cloud 上的 NVIDIA Blackwell GPU 与 PCC 硬件安全架构，支持 Apple Foundation Models 的服务端推理。原文同时说明 NVIDIA Confidential Computing 通过可信执行环境隔离 AI 工作负载，并在敏感数据发送到服务器前，以加密方式验证底层基础设施未被篡改。",
          "judgment": "这是一条 P2 级平台能力强化事件。它暂时没有披露订单规模或收入贡献，但说明 NVIDIA 正在进入更高价值的云端推理安全层，而不仅是提供通用算力。对判断最关键的是，消费级 AI 与云端推理开始把隐私、安全和可信执行能力纳入采购条件，Blackwell 的平台价值由此向机密计算延伸。",
          ...
          "source_summary": [
            ...
            "原文先交代 PCC 的变化：Apple Intelligence 的部分下一代功能，将把服务端推理能力放到 Google Cloud，同时仍保持 PCC 的硬件安全架构。NVIDIA 在这里与 Apple 和 Google 协作，提供带 Confidential Computing 的 Blackwell GPU，使敏感数据在进入服务器前，可以先验证底层基础设施没有被篡改。",
            "文章对机密计算的解释很明确。NVIDIA Confidential Computing 通过硬件级可信执行环境隔离 AI 工作负载，并允许系统以加密方式证明底层基础设施未被篡改；对最终用户而言，连系统构建者也无法查看其数据、聊天或对话内容。这意味着 NVIDIA 切入的不是普通推理算力，而是更高安全等级的云端推理场景。",
          ...
          "evidence": [
            "原文明确称 NVIDIA GPUs with Confidential Computing 已用于 Apple Private Cloud Compute 的 confidential inference。",
            "PCC 的部署范围从 Apple 自有数据中心扩展到 Google Cloud，说明这不是封闭私有环境，而是开始进入外部云基础设施。",
            "NVIDIA 与 Apple、Google 协作，使用 NVIDIA Blackwell GPUs with Confidential Computing 集成到 PCC 的 hardware security architecture 中。",
            "文章解释机密计算通过 trusted execution environments 隔离 AI 工作负载，并在敏感数据发送前对基础设施完整性做 cryptographic verification。",
            "原文强调即使是系统构建者也无法查看用户数据、聊天或对话内容，说明这条能力主打高隐私、高信任等级的云端推理场景。"
          ],
          "business_analysis": "业务层面，这条事件把 NVIDIA 的推理能力进一步延伸到高隐私消费级 AI 云端基础设施。Apple Intelligence 若要把更多模型能力放到云端，就必须同时解决延迟、吞吐和隐私保护；NVIDIA 在这里提供的不是普通 GPU，而是可嵌入 PCC 安全架构的机密计算底座。若这类需求扩大，NVIDIA 的价值将不只来自训练和企业推理，还可能覆盖消费级云端推理、可信执行环境以及更严格合规场景下的推理部署。",
          "valuation_analysis": "估值和动作上，这条事件更像中期平台化证据，而不是短期业绩催化。正面在于，Apple、Google Cloud 与 NVIDIA Blackwell 机密计算被放进同一条实际部署链路，证明云端推理的竞争维度正在从单纯算力和成本，扩展到安全隔离与可验证可信执行。限制在于，文章没有披露部署规模、GPU 数量、定价或长期采购承诺，因此不能据此直接上调收入预测。动作上维持 A 池核心，把 confidential inference 是否成为新的高附加值推理赛道列入验证清单。",
          "verification": [
          ...
          "reviewed_at": "2026-06-22T23:05:00",
        ...
        },
        {
          ...
          "source_candidate_title": "How the UK Is Turning Sovereign AI Ambition Into Action With NVIDIA Technologies",
          "date": "2026-06-07",
          "fetched_at": "",
          "type": "主权 AI / 区域云基础设施",
          "fact": "2026-06-07，NVIDIA 披露英国主权 AI 基建的最新落地进展：过去一年，计划在英国本土部署 AI 基础设施的 AI 云提供商数量已翻倍；Nebius 计划新增三处先进 NVIDIA AI 基建设施，全部爬坡完成后预计在 2027 年达到 65 兆瓦；CoreWeave 正在英国 AI Growth Zones 建设，另有七家 NVIDIA AI Cloud 生态伙伴在推进中。BT 与 Nscale 计划在三处 BT 站点建设主权 AI 数据中心。科研算力侧，Isambard-AI 基于 5,400 颗 NVIDIA GH200 Grace Hopper Superchips 并使用零碳电力运行；英国 Sovereign AI Fund 已开始把这类本土算力支持给 Ineffable Intelligence 等本国公司。",
          "judgment": "这是一条 P1 级需求承接层强化事件。它的重要性不在于英国又宣布支持 AI，而在于 NVIDIA 已经把主权 AI 叙事落成更完整的供给链条：区域云、国家级科研算力、电信机房和本土创业公司开始围绕同一套平台部署和消费算力。对投资判断更关键的是，这说明 NVIDIA 的新增需求来源正在从超大云厂商继续外溢到国家级与区域级基础设施层。",
          "action": "维持 A 池核心，并上调主权 AI 与区域云落地验证优先级",
          "priority": "P1",
          "sort_key": 20260607,
          "source_url": "https://blogs.nvidia.com/blog/uk-sovereign-ai-advancements/",
          "source_doc": "云端研究简报系统/outputs/snapshots/nvidia__20260608-152847__investor.nvidia.com_news_press-releases_default.aspx.html",
          "source_summary": [
          ...
          "evidence": [
            "原文直接称，过去一年计划在英国本土部署 AI 基础设施的 AI cloud providers 数量已经翻倍。",
            "Nebius 宣布三处新的先进 NVIDIA AI 基建设施，完全爬坡后预计在 2027 年达到 65 megawatts。",
            "BT 与 Nscale 计划在三处既有 BT 站点建设 sovereign AI data centers，把 NVIDIA AI 基础设施、Nscale 全栈和 BT 全国连接骨干整合起来。",
            "Isambard-AI 被描述为英国最强计算机，基于 5,400 颗 NVIDIA GH200 Grace Hopper Superchips，并全部使用 zero-carbon electricity。",
            "英国 Sovereign AI Fund 已把本土算力资源分配给 Ineffable Intelligence 等本国公司，说明主权算力开始进入创业和科研实际使用，而不是停留在政策宣示。"
          ],
          "business_analysis": "业务层面，这条事件强化了 NVIDIA 在主权 AI 与区域云基础设施中的平台位置。65 兆瓦级别的新增部署、BT/Nscale 的主权数据中心计划以及 5,400 颗 GH200 的国家科研集群，说明需求已经不仅是云厂商训练集群，而是开始覆盖电信机房、本国科研、创业孵化和监管敏感行业。这样一来，NVIDIA 不只是卖 GPU，而是在区域云、电信连接、主权控制和本土 AI 创新之间提供一套可复用的平台底座，延长需求曲线并分散客户结构。",
          "valuation_analysis": "估值和动作上，这条事件支持高估值中的主权 AI 与区域云扩散逻辑，但仍不足以单独上调短期盈利预测。正面在于，原文给出了可验证的容量与部署信号，包括 provider 数量翻倍、Nebius 65 兆瓦、BT/Nscale 三站点和 5,400 颗 GH200；这比泛泛合作新闻更接近真实基建节奏。限制在于，文章没有披露 NVIDIA 对应的订单金额、装机节奏、利用率和毛利率贡献。动作上维持 A 池核心，但要把主权 AI 需求是否能持续转成高质量数据中心收入列为下一阶段重点验证。",
          "verification": [
          ...
          "reviewed_at": "2026-06-22T22:55:00",
          "review_status": "reviewed"
        },
        {
        ...
        },
        {
          ...
          "priority": "P1",
          "sort_key": 20260331,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/6d15/一个财务投资应用/长期高潜力公司跟踪系统/28-NVIDIA动态更新样例V1.md"
        },
        {
    ...
    "tsmc": {
      ...
      "events": [
        ...
        },
        {
          ...
          "priority": "P1",
          "sort_key": 20260416,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/6d15/一个财务投资应用/长期高潜力公司跟踪系统/25-TSMC动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260429,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/6d15/一个财务投资应用/长期高潜力公司跟踪系统/24-Microsoft动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260319,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/6d15/一个财务投资应用/长期高潜力公司跟踪系统/20-阿里巴巴动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P2",
          "sort_key": 20260107,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/6d15/一个财务投资应用/长期高潜力公司跟踪系统/23-汇川技术动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260422,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/6d15/一个财务投资应用/长期高潜力公司跟踪系统/26-GE Vernova动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P2",
          "sort_key": 20260419,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/6d15/一个财务投资应用/长期高潜力公司跟踪系统/18-立讯精密动态更新样例V1.md"
        },
        {
    ...
    "constellation": {
      ...
      "events": [
        ...
        },
        {
          ...
          "priority": "P2",
          "sort_key": 20260318,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/6d15/一个财务投资应用/长期高潜力公司跟踪系统/27-Constellation Energy动态更新样例V1.md"
        },
        {
