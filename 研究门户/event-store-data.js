      ...
      "events": [
        {
          ...
          "date": "2026-06-09",
          "fetched_at": "",
          "type": "平台合作 / 机密计算 / 推理基础设施",
          "fact": "2026-06-09，NVIDIA 披露其具备 Confidential Computing 能力的 GPU 已用于 Apple 的 Private Cloud Compute（PCC）机密推理场景，并随着 PCC 从 Apple 自有数据中心扩展到 Google Cloud，开始承载 Apple Foundation Models 的部分 server-side inference。原文点名使用 NVIDIA Blackwell GPU，并说明其机密计算能力已集成进 PCC 的硬件安全架构，用于支撑下一代 Apple Intelligence 功能。",
          "judgment": "这是一条 P2 级平台外延事件。它真正改变的不是 NVIDIA 又多了一个合作伙伴，而是公司开始进入消费级 AI 功能背后的高隐私云端推理链条。对 NVIDIA 来说，这意味着 Blackwell 的价值不再只由训练吞吐或通用推理决定，机密计算、云端部署和可信执行环境也开始成为平台能力的一部分。没有改变的是，原文仍缺少订单规模、部署范围和商业化口径，所以它更适合作为平台化与推理场景扩展的证据，而不是短期业绩上调依据。",
          ...
          "source_doc": "",
          "source_summary": [
            "这篇原文讲的不是泛泛而谈的“AI 安全”概念，而是 Apple 已把 Private Cloud Compute（PCC）中的部分机密推理工作负载扩展到 Google Cloud，并在这条链路里使用带有 Confidential Computing 的 NVIDIA GPU。也就是说，NVIDIA 不只是继续卖训练卡，而是在 Apple Intelligence 的云端推理安全架构里占到一个明确位置。",
            "原文进一步说明，这套部署面向 Apple Foundation Models 的 server-side inference，由 Apple 与 Google 基于 Gemini 技术栈共同构建，运行在集成进 PCC 硬件安全架构的 NVIDIA Blackwell GPU 上。文章把“Apple + Google Cloud + NVIDIA Blackwell + PCC”放进同一个架构叙事里，核心增量是高隐私要求的消费级 AI 功能开始依赖云端机密推理能力，而不是只停留在端侧模型。",
            "安全机制部分，NVIDIA 把 Confidential Computing 定义为 AI 工作负载的硬件级隔离层：通过 trusted execution environments 隔离处理中的数据，并在敏感数据发送前进行加密校验，验证基础设施未被篡改。对终端用户的含义是，连系统建设方本身也不应看到聊天、对话或个人数据内容。",
          ...
          "evidence": [
            "原文明确写出 NVIDIA GPUs with Confidential Computing 已用于 Apple Private Cloud Compute 的 confidential inference，且 PCC 正从 Apple 自有数据中心扩展到 Google Cloud。",
            "文章指出这些 GPU 将支持 Apple Foundation Models 的 server-side inference，并称相关模型由 Apple 与 Google 基于 Gemini 技术栈共同构建。",
            "原文点名使用 NVIDIA Blackwell GPUs，并说明其已集成进 Private Cloud Compute 的 hardware security architecture。",
            "NVIDIA 将 Confidential Computing 描述为通过 trusted execution environments 隔离工作负载、并在敏感数据发送前进行加密校验的硬件安全层。",
            "原文强调在该架构下，终端用户的数据、聊天和对话内容不应被系统建设方查看，说明这不是普通推理部署，而是高隐私要求的云端推理场景。"
          ],
          ...
          "valuation_analysis": "估值和动作上，这条事件支持继续给 NVIDIA 平台溢价，但力度应低于财报、数据中心收入或大额 AI 工厂订单。正面在于：Apple 的 PCC 场景对隐私和安全要求很高，NVIDIA 能进入这类部署，说明其在可信推理基础设施上的能力得到头部客户认可；同时 Google Cloud 的加入，让这条线不只是封闭的 Apple 内部项目。限制在于：原文没有披露 GPU 数量、收入贡献、软件收费或后续扩容节奏，短期难以映射到盈利预测。动作上维持 A 池核心，把“机密计算是否成为 Blackwell 新的差异化卖点”列为后续验证点，而不是因为单篇合作文章提高仓位。",
          "verification": [
            ...
            "对比 AMD、Intel 及云厂商自研方案在 trusted execution 与 secure inference 上的进展，判断 NVIDIA 的机密计算是否具备可持续差异化。"
          ],
          "reviewed_at": "2026-06-13T07:42:39",
        ...
        },
        {
          ...
          "priority": "P1",
          "sort_key": 20260331,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/b1f1/一个财务投资应用/长期高潜力公司跟踪系统/28-NVIDIA动态更新样例V1.md"
        },
        {
    ...
    "tsmc": {
      ...
      "events": [
        ...
        },
        {
          ...
          "priority": "P1",
          "sort_key": 20260416,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/b1f1/一个财务投资应用/长期高潜力公司跟踪系统/25-TSMC动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260429,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/b1f1/一个财务投资应用/长期高潜力公司跟踪系统/24-Microsoft动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260319,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/b1f1/一个财务投资应用/长期高潜力公司跟踪系统/20-阿里巴巴动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P2",
          "sort_key": 20260107,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/b1f1/一个财务投资应用/长期高潜力公司跟踪系统/23-汇川技术动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P1",
          "sort_key": 20260422,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/b1f1/一个财务投资应用/长期高潜力公司跟踪系统/26-GE Vernova动态更新样例V1.md"
        },
        {
      ...
      "events": [
        {
          ...
          "priority": "P2",
          "sort_key": 20260419,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/b1f1/一个财务投资应用/长期高潜力公司跟踪系统/18-立讯精密动态更新样例V1.md"
        },
        {
    ...
    "constellation": {
      ...
      "events": [
        ...
        },
        {
          ...
          "priority": "P2",
          "sort_key": 20260318,
          "source_doc": "/Users/tianyuehua/.codex/worktrees/b1f1/一个财务投资应用/长期高潜力公司跟踪系统/27-Constellation Energy动态更新样例V1.md"
        },
        {
