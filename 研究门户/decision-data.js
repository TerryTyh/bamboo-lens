window.BAMBOO_LENS_DECISION_QUEUE = {
  ...
  "items": [
    ...
    },
    {
      ...
      "type": "客户 / 机密计算 / 云推理",
      "priority": "P2",
      "decision_action": "维持核心跟踪；把机密计算在高隐私推理场景的采用率列入下一轮验证",
      "why": "这是一条 P2 级正式事件。它改变的不是 NVIDIA 当季收入预期，而是市场对其“安全推理基础设施”能力的认知边界。过去市场更容易把 NVIDIA 估值建立在训练集群、超大云厂商资本开支和 AI 工厂平台上；这条信息补了一层更细的生产级场景验证: 当生成式 AI 进入高隐私、强合规、面向消费端大规模用户的服务端推理时，NVIDIA 也在切入底层执行层。没有变化的是，文章没有披露订单规模、GPU 数量、收入贡献或 attach rate，因此还不足以单独上调盈利预测或仓位动作。",
      "read_next": "打开事件详情，核对事实、判断、估值/动作影响，并决定是否回写公司主页当前结论。",
