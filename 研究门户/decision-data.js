window.BAMBOO_LENS_DECISION_QUEUE = {
  ...
  "items": [
    ...
    },
    {
      ...
      "type": "战略叙事 / 平台定义",
      "priority": "P3",
      "decision_action": "纳入公司页“业务理解/跟踪重点”：用 AI 工厂单位经济指标框架统一跟踪 GPU+网络+软件协同兑现",
      "why": "这是一条“叙事/框架”类事件：原文的增量不是新增某个可立刻计入收入的产品，而是用“AI 工厂 = 持续制造 tokens 的基础设施”把 NVIDIA 的 GPU、网络、系统与软件栈统一到同一套单位经济指标上。对研究而言，它提供了把后续产品发布与客户 capex 讨论落到可验证指标（tokens/W、每 token 成本、利用率）的框架，可用于公司页“业务理解/跟踪重点”的长期更新。",
      "read_next": "打开事件详情，核对事实、判断、估值/动作影响，并决定是否回写公司主页当前结论。",
    ...
    },
    {
      ...
      "priority": "P3",
      "decision_action": "纳入公司页“业务理解/跟踪重点”：把 Vera CPU 作为 AI 工厂全栈（GPU+CPU+网络）的一条新增验证线",
      "why": "这条事件的增量在于：NVIDIA 正在把“AI 工厂”的全栈边界扩到 CPU，并用“智能体工作负载需要更强 CPU + 更高内存带宽/能效”的口径解释其必要性。它不直接带来短期财务数字，但如果 Vera 能在企业/云端 AI 工厂部署里成为标准配置，将增强 NVIDIA 在系统级销售中的话语权，并把更多价值从单点 GPU 延伸到 CPU/平台能效与编排。",
      "read_next": "打开事件详情，核对事实、判断、估值/动作影响，并决定是否回写公司主页当前结论。",
    ...
    },
    {
      ...
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/constellation__20260529-144007__investors.constellationenergy.com_events-and-presentations_past-events.html",
      "event_index": null,
      "sort_key": 20260511,
      "score": 14
    },
    ...
    },
    {
      ...
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/tsmc__20260529-144007__pr.tsmc.com_english_latest-news.html",
      "event_index": null,
      "sort_key": 20260416,
      "score": 10
    },
