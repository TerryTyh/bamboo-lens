window.BAMBOO_LENS_DECISION_QUEUE = {
  ...
  "items": [
    ...
    },
    {
      ...
      "priority": "P2",
      "decision_action": "维持 A 池核心；把 CPU 扩张与 agentic AI 平台化兑现列为新增验证点",
      "why": "这条事件的增量不在短期财务数字，而在 NVIDIA 明确把“AI 工厂平台”从 GPU/网络继续向 CPU 延伸：它把智能体执行与编排层的关键瓶颈（CPU 侧并发与确定性性能）纳入自家平台路线。现阶段应把它视为平台化与产品化的信号，而不是已经兑现的收入拐点：交付对象是头部实验室与云厂商，代表生态验证开始，但仍需要看到 OEM/云规模化上架与真实采购节奏。",
      "read_next": "打开事件详情，核对事实、判断、估值/动作影响，并决定是否回写公司主页当前结论。",
    ...
    },
    {
      ...
      "priority": "P2",
      "decision_action": "维持 A 池核心；把企业侧 AI 工厂交付与 Rubin 供给节奏纳入下一阶段验证",
      "why": "这条事件的核心不是“演讲式口号”，而是企业侧 AI 工厂产品化的两层信号：第一，Rubin 平台正通过 OEM（Dell）把机架级系统、网络与整机一体化（PowerRack）打包到企业私域部署场景；第二，文中用 cost-per-token、GPU/rack、液冷等可工程化指标描述部署形态，显示竞争焦点从单卡性能转向“系统吞吐/能耗/集成成本”。但需要注意：文中大量为厂商宣称与对比口径，不能直接等同于可验证的真实 TCO；对投资判断的关键在于 Rubin 的供给节奏与企业侧交付规模是否会在后续季度体现为系统/网络/软件的更高占比与更强粘性。",
      "read_next": "打开事件详情，核对事实、判断、估值/动作影响，并决定是否回写公司主页当前结论。",
    ...
    },
    {
      ...
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/constellation__20260526-144306__investors.constellationenergy.com_events-and-presentations_past-events.html",
      "event_index": null,
      "sort_key": 20260511,
      "score": 14
    },
    ...
    },
    {
      ...
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/nvidia__20260526-144306__investor.nvidia.com_news_press-releases_default.aspx.html",
      "event_index": null,
      "sort_key": 20260521,
      "score": 6
    },
