window.BAMBOO_LENS_DECISION_QUEUE = {
  ...
  "items": [
    ...
    },
    {
      ...
      "priority": "P2",
      "decision_action": "维持 A 池核心；把 Vera CPU 量产与客户采用纳入跟踪验证",
      "why": "这条事件的核心在于：Vera 由“发布/路线图”进入“交付/生态验证”，并且首批客户覆盖前沿模型实验室与云基础设施方，强化了 NVIDIA 以“AI 工厂”全栈（CPU+GPU+网络+系统）去锁定工作负载与客户部署路径的策略。",
      "read_next": "打开事件详情，核对事实、判断、估值/动作影响，并决定是否回写公司主页当前结论。",
    ...
    },
    {
      ...
      "priority": "P3",
      "decision_action": "维持跟踪；把 Dell AI Factory 相关系统与网络新品作为企业侧需求验证点",
      "why": "这条事件更像“生态与产品组合更新”的打包呈现：它强化了 NVIDIA 在企业侧以整套 AI 工厂（GPU+CPU+网络+系统）进入预算与部署流程的路径，但其投资含金量不在于演讲措辞，而在于这些新品与口径能否转化为可持续的企业订单与交付节奏。",
      "read_next": "打开事件详情，核对事实、判断、估值/动作影响，并决定是否回写公司主页当前结论。",
    ...
    },
    {
      ...
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/constellation__20260525-134852__investors.constellationenergy.com_events-and-presentations_past-events.html",
      "event_index": null,
      "sort_key": 20260511,
      "score": 14
    },
    ...
    },
    {
      ...
      "why": "这条事件对主业经营的直接影响有限，更重要的信号是“股权关系与业务合作解耦”：TSMC 继续维持必要的制造/技术协同，但降低非核心股权绑定并把资源聚焦到核心业务与先进制程/先进封装等关键议题。整体应作为资本配置与非核心资产管理的跟踪节点，而非主业景气拐点。",
      "read_next": "打开事件详情，核对事实、判断、估值/动作影响，并决定是否回写公司主页当前结论。",
    ...
    },
    {
      ...
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/nvidia__20260525-134852__investor.nvidia.com_news_press-releases_default.aspx.html",
      "event_index": null,
      "sort_key": 20260520,
      "score": 11
    },
    ...
    },
    {
      ...
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/tsmc__20260525-134852__pr.tsmc.com_english_latest-news.html",
      "event_index": null,
      "sort_key": 20260416,
      "score": 10
    },
