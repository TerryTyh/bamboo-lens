window.BAMBOO_LENS_DECISION_QUEUE = {
  ...
  "items": [
    ...
    },
    {
      ...
      "priority": "P1",
      "decision_action": "维持A池核心；把全年EPS兑现、920MW长约质量、Crane 2027重启和Calpine资产处置列为下一轮验证主线。",
      "why": "这是一条 P1 级财报验证事件。与 3 月 Outlook 相比，Q2 不是只重复成长型电力平台叙事，而是把调整后 EPS、全年指引、核电长约、Crane 重启和 Calpine 整合处置同时推进了一步。正面是调整后 EPS 上修和 920MW 长约说明核电与可调度电力的商业价值正在落到合同和业绩上；约束是 GAAP EPS 同比下降、换料停机影响容量因子、Brazos Valley 出售仍需 DOJ 批准，且 Crane 2027 重启仍有执行和监管风险。",
      "read_next": "打开事件详情，核对事实、判断、估值/动作影响，并决定是否回写公司主页当前结论。",
    ...
    },
    {
      ...
      "priority": "P2",
      "decision_action": "维持A池核心跟踪；把Blackwell/Rubin机架级能效、推理每token成本和生产客户采用作为高估值验证线",
      "why": "这是一条P2级平台经济性事件。它不直接新增一个可确认订单，但把NVIDIA数据中心业务的竞争焦点从单卡性能扩展到机架级推理吞吐、能耗、软件优化和生产稳定性。对高估值最关键的含义是：如果推理需求成为下一阶段AI资本开支主轴，客户采购时会更重视每瓦token产出和每token成本，而这正是NVIDIA把GPU、NVLink、网络、软件和电力管理打包成AI工厂平台的定价依据。",
      "read_next": "打开事件详情，核对事实、判断、估值/动作影响，并决定是否回写公司主页当前结论。",
    ...
    },
    {
      ...
      "priority": "P1",
      "decision_action": "维持AI服务器ODM重点跟踪；把验证重点从利润预告转向现金流、存货、应收和高端平台量产质量。",
      "why": "这条半年报把 7 月业绩预告中的利润弹性推进到正式财务验证。正面是收入、扣非利润和经营现金流同步改善，AI 服务器和高速网络设备不再只是订单叙事，而是已经进入收入、出货和利润表；同时 GPU、ASIC、液冷、整机柜、800G 交换机、SuperNIC 和 CPO 样机共同说明工业富联的角色在从普通代工向 AI 基础设施系统集成延伸。限制也更清楚：存货和应收随放量上升，现金流改善部分依赖销售回款和经营性应付增加，还不能简单等同于自由现金流质量已经完全改善。",
      "read_next": "打开事件详情，核对事实、判断、估值/动作影响，并决定是否回写公司主页当前结论。",
    ...
    },
    {
      ...
      "type": "资本配置 / 股份回购",
      "priority": "P2",
      "decision_action": "维持AI服务器ODM重点跟踪；把回购执行作为估值支撑和资本配置纪律观察，不替代现金流与存货验证。",
      "why": "这是一条 P2 级资本配置事件。它的核心不是证明 AI 服务器业务继续增长，而是说明工业富联在半年报高增长之后开始实际执行股份回购，用现金行为回应估值和股东权益。正面含义是：首次投入约 1.49 亿元，说明回购不再停留在董事会方案；回购价格远低于 103 元上限，显示公司在当前价格区间愿意开始买入。限制也明确：首笔金额仅约占 10 亿元下限的 14.9%，占 20 亿元上限的 7.5%，回购比例只有 0.01%，对 EPS、股本和自由现金流的量化影响还很小。",
      "read_next": "打开事件详情，核对事实、判断、估值/动作影响，并决定是否回写公司主页当前结论。",
    ...
    },
    {
      ...
      "type": "平台技术 / 物理AI",
      "priority": "P2",
      "decision_action": "维持A池核心；把物理AI和Omniverse作为数据中心需求的中长期验证线，不因单篇技术文章改变仓位",
      "why": "这是一条P2级平台技术事件，不是短期收入确认事件。它强化的是 NVIDIA 在物理 AI 中“GPU算力 + 世界模型 + Omniverse仿真 + Agent Toolkit工具链”的系统级平台位置：客户如果要把机器人、自动驾驶或视觉 AI 从演示推进到可验证部署，数据生成、仿真、后训练和验证会成为新的算力消耗来源。限制也要保留：原文没有披露商业订单、价格、收入规模或付费客户数量，不能把它直接当作财报催化；它更适合写入 NVIDIA 公司页的业务理解和中长期验证线。",
      "read_next": "打开事件详情，核对事实、判断、估值/动作影响，并决定是否回写公司主页当前结论。",
    ...
    },
    {
      ...
      "priority": "P2",
      "decision_action": "维持核心跟踪；把GPU直连存储、Vera/BlueField数据服务和Storage-Next标准化作为AI工厂平台控制点观察",
      "why": "这是一条P2级平台控制点事件。它不会直接改变NVIDIA下一季收入、毛利率或订单判断，但补上了AI工厂主线中容易被忽略的数据路径：当GPU不再只是等待CPU和存储系统喂数据，而是通过GPUDirect Storage、cuFile、SCADA、Vera和BlueField把存储访问、加密压缩和数据服务纳入加速计算路径，NVIDIA的控制范围会从GPU/网络继续延伸到AI工厂底层I/O和存储标准。限制也很清楚：原文没有披露客户采购金额、收入贡献、收费模式或对Data Center分部的量化拉动，因此只能作为平台生态与架构趋势沉淀，不能上调盈利预测。",
      "read_next": "打开事件详情，核对事实、判断、估值/动作影响，并决定是否回写公司主页当前结论。",
    ...
    },
    {
      ...
      "type": "客户部署 / AI工厂 / 生命科学",
      "priority": "P2",
      "decision_action": "维持A池核心跟踪；把生命科学AI工厂作为企业级行业渗透样本观察，不因单一客户案例改变仓位",
      "why": "这是一条P2级客户部署事件。它的价值不在于单笔金额披露，因为原文没有给订单价格或收入确认节奏；价值在于BMS把NVIDIA AI工厂从实验集群扩展到全球研发生产平台，说明企业级行业客户正在用机架级系统、BioNeMo、Mission Control和智能体工作流重构药物发现流程。它验证的是NVIDIA数据中心需求不只来自互联网大模型公司，也可能来自制药、科学计算和行业研发的长期算力预算。",
      "read_next": "打开事件详情，核对事实、判断、估值/动作影响，并决定是否回写公司主页当前结论。",
    ...
    },
    {
      ...
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/wus__20260825-122633__vip.stock.finance.sina.com.cn_corp_view_vCB_AllBulletin.php_Page_1_stockid_002463.html",
      "event_index": null,
      "sort_key": 20260826,
      "score": 13
    },
    ...
    },
    {
      ...
      "read_next": "先打开官方来源阅读全文，提取事实和数字；如果只有标题或营销话术，就保留候选不升级。",
      "source_url": "https://money.finance.sina.com.cn/corp/go.php/vCB_AllBulletin/stockid/300502.phtml",
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/eoptolink__20260824-122551__money.finance.sina.com.cn_corp_go.php_vCB_AllBulletin_stockid_300502.phtml.html",
      "event_index": null,
      "sort_key": 20260825,
      "score": 13
    },
    ...
    },
    {
      ...
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/fii__20260811-124030__vip.stock.finance.sina.com.cn_corp_go.php_vCB_AllBulletin_stockid_601138.phtml.html",
      "event_index": null,
      "sort_key": 20260812,
      "score": 13
    },
    ...
    },
    {
      ...
      "read_next": "先打开官方来源阅读全文，提取事实和数字；如果只有标题或营销话术，就保留候选不升级。",
      "source_url": "https://money.finance.sina.com.cn/corp/go.php/vCB_AllBulletin/stockid/002916.phtml?ftype=lsgg",
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/shennan__20260918-152613__money.finance.sina.com.cn_corp_go.php_vCB_AllBulletin_stockid_002916.phtml_ftype_lsgg.html",
      "event_index": null,
      "sort_key": 20260917,
      "score": 9
    },
    {
      ...
      "read_next": "先打开官方来源阅读全文，提取事实和数字；如果只有标题或营销话术，就保留候选不升级。",
      "source_url": "https://vip.stock.finance.sina.com.cn/corp/view/vCB_AllBulletin.php?Page=1&stockid=002463",
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/wus__20260915-155350__vip.stock.finance.sina.com.cn_corp_view_vCB_AllBulletin.php_Page_1_stockid_002463.html",
      "event_index": null,
      "sort_key": 20260915,
      "score": 9
    },
    ...
    },
    {
      ...
      "read_next": "先打开官方来源阅读全文，提取事实和数字；如果只有标题或营销话术，就保留候选不升级。",
      "source_url": "https://money.finance.sina.com.cn/corp/go.php/vCB_AllBulletin/stockid/002916.phtml?ftype=lsgg",
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/shennan__20260908-153857__money.finance.sina.com.cn_corp_go.php_vCB_AllBulletin_stockid_002916.phtml_ftype_lsgg.html",
      "event_index": null,
      "sort_key": 20260909,
      "score": 9
    },
    ...
    },
    {
      ...
      "read_next": "先打开官方来源阅读全文，提取事实和数字；如果只有标题或营销话术，就保留候选不升级。",
      "source_url": "https://vip.stock.finance.sina.com.cn/corp/view/vCB_AllBulletin.php?Page=1&stockid=002463",
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/wus__20260908-153857__vip.stock.finance.sina.com.cn_corp_view_vCB_AllBulletin.php_Page_1_stockid_002463.html",
      "event_index": null,
      "sort_key": 20260908,
      "score": 9
    },
    ...
    },
    {
      ...
      "read_next": "先打开官方来源阅读全文，提取事实和数字；如果只有标题或营销话术，就保留候选不升级。",
      "source_url": "https://vip.stock.finance.sina.com.cn/corp/view/vCB_AllBulletin.php?Page=1&stockid=002463",
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/wus__20260907-165051__vip.stock.finance.sina.com.cn_corp_view_vCB_AllBulletin.php_Page_1_stockid_002463.html",
      "event_index": null,
      "sort_key": 20260907,
      "score": 9
    },
    {
      ...
      "read_next": "先打开官方来源阅读全文，提取事实和数字；如果只有标题或营销话术，就保留候选不升级。",
      "source_url": "https://vip.stock.finance.sina.com.cn/corp/view/vCB_AllBulletin.php?Page=1&stockid=002463",
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/wus__20260904-152534__vip.stock.finance.sina.com.cn_corp_view_vCB_AllBulletin.php_Page_1_stockid_002463.html",
      "event_index": null,
      "sort_key": 20260904,
      "score": 9
    },
    ...
    },
    {
      ...
      "read_next": "先打开官方来源阅读全文，提取事实和数字；如果只有标题或营销话术，就保留候选不升级。",
      "source_url": "https://money.finance.sina.com.cn/corp/go.php/vCB_AllBulletin/stockid/002916.phtml?ftype=lsgg",
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/shennan__20260827-212604__money.finance.sina.com.cn_corp_go.php_vCB_AllBulletin_stockid_002916.phtml_ftype_lsgg.html",
      "event_index": null,
      "sort_key": 20260827,
      "score": 9
    },
    ...
    },
    {
      ...
      "read_next": "先打开官方来源阅读全文，提取事实和数字；如果只有标题或营销话术，就保留候选不升级。",
      "source_url": "https://vip.stock.finance.sina.com.cn/corp/go.php/vCB_AllBulletin/stockid/601138.phtml",
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/fii__20260818-122338__vip.stock.finance.sina.com.cn_corp_go.php_vCB_AllBulletin_stockid_601138.phtml.html",
      "event_index": null,
      "sort_key": 20260819,
      "score": 9
    },
    {
      ...
      "read_next": "先打开官方来源阅读全文，提取事实和数字；如果只有标题或营销话术，就保留候选不升级。",
      "source_url": "https://vip.stock.finance.sina.com.cn/corp/view/vCB_AllBulletin.php?Page=1&stockid=002463",
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/wus__20260812-124353__vip.stock.finance.sina.com.cn_corp_view_vCB_AllBulletin.php_Page_1_stockid_002463.html",
      "event_index": null,
      "sort_key": 20260812,
      "score": 9
    },
    ...
    },
    {
      ...
      "read_next": "先打开官方来源阅读全文，提取事实和数字；如果只有标题或营销话术，就保留候选不升级。",
      "source_url": "https://money.finance.sina.com.cn/corp/go.php/vCB_AllBulletin/stockid/002916.phtml?ftype=lsgg",
      "source_doc": "/home/runner/work/bamboo-lens/bamboo-lens/云端研究简报系统/outputs/snapshots/shennan__20260821-122517__money.finance.sina.com.cn_corp_go.php_vCB_AllBulletin_stockid_002916.phtml_ftype_lsgg.html",
      "event_index": null,
      "sort_key": 20260822,
      "score": 7
    },
