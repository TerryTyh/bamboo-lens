window.BAMBOO_LENS_REVIEW_DRAFTS = {
    ...
    "priority_batch": [
      {
        ...
        "portal_doc": "./docs/review-drafts/auto-nvidia-nvidia-and-google-cloud-empower-the-next-wave-of-ai-builders.md",
  ...
  "by_key": {
    ...
    "nvidia::nvidia announces financial results for first quarter fiscal 2027": {
      "draft_id": "auto-nvidia-nvidia-announces-financial-results-for-first-quarter-fiscal-2027",
      "company": "nvidia",
      "company_name": "NVIDIA",
      ...
      "portal_doc": "./docs/review-drafts/auto-nvidia-nvidia-announces-financial-results-for-first-quarter-fiscal-2027.md",
      "has_source_body": false,
      "company_page_writeback": {
        "targets": [
          "最新动态",
    ...
    "nvidia::nvidia and google cloud empower the next wave of ai builders": {
      "draft_id": "auto-nvidia-nvidia-and-google-cloud-empower-the-next-wave-of-ai-builders",
      "company": "nvidia",
      "company_name": "NVIDIA",
      "title": "NVIDIA and Google Cloud Empower the Next Wave of AI Builders",
