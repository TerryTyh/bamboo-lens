window.BAMBOO_LENS_REVIEW_DRAFTS = {
  ...
  "summary": {
    ...
    "readiness_counts": {
      ...
      "readable_needs_review": 4,
      "needs_source": 3,
      "low_investment_signal": 4
    },
    "priority_batch": [
      {
      ...
      {
        "draft_id": "auto-nvidia-why-financial-institutions-are-converging-on-transaction-foundation-models-to-build-their-own-in",
        "company": "nvidia",
        "company_name": "NVIDIA",
        ...
        "portal_doc": "./docs/review-drafts/auto-nvidia-why-financial-institutions-are-converging-on-transaction-foundation-models-to-build-their-own-in.md",
        "has_source_body": true,
        "company_page_writeback": {
          "targets": [
            "最新动态",
          ...
          "guidance": "若有客户、规模、商业化路径或技术证据，应沉淀到业务地图和护城河，不要只留在事件详情里。"
        }
      },
      {
        "draft_id": "auto-nvidia-nvidia-enables-the-next-era-of-physical-ai-research-with-agent-skills-for-autonomous-vehicles-ro",
        "company": "nvidia",
        "company_name": "NVIDIA",
        ...
        "portal_doc": "./docs/review-drafts/auto-nvidia-nvidia-enables-the-next-era-of-physical-ai-research-with-agent-skills-for-autonomous-vehicles-ro.md",
        "has_source_body": true,
        "company_page_writeback": {
          "targets": [
            "最新动态",
      ...
      {
        "draft_id": "auto-nvidia-nvidia-jetson-brings-agentic-ai-to-the-physical-world",
        "company": "nvidia",
        "company_name": "NVIDIA",
        ...
        "portal_doc": "./docs/review-drafts/auto-nvidia-nvidia-jetson-brings-agentic-ai-to-the-physical-world.md",
        "has_source_body": true,
        "company_page_writeback": {
          "targets": [
            "最新动态",
  ...
  "by_key": {
    ...
    "nvidia::nvidia partners with microsoft on unified stack for agentic ai deployment, from windows devices to cloud to local": {
      "draft_id": "auto-nvidia-nvidia-partners-with-microsoft-on-unified-stack-for-agentic-ai-deployment-from-windows-devices-t",
      "company": "nvidia",
      "company_name": "NVIDIA",
      ...
      "portal_doc": "./docs/review-drafts/auto-nvidia-nvidia-partners-with-microsoft-on-unified-stack-for-agentic-ai-deployment-from-windows-devices-t.md",
      "has_source_body": true,
      "company_page_writeback": {
        "targets": [
          "最新动态",
    ...
    "nvidia::nvidia research unlocks advanced grasping, smarter autonomous driving and agent training at scale": {
      "draft_id": "auto-nvidia-nvidia-research-unlocks-advanced-grasping-smarter-autonomous-driving-and-agent-training-at-scale",
      "company": "nvidia",
      "company_name": "NVIDIA",
      ...
      "portal_doc": "./docs/review-drafts/auto-nvidia-nvidia-research-unlocks-advanced-grasping-smarter-autonomous-driving-and-agent-training-at-scale.md",
      "has_source_body": true,
      "company_page_writeback": {
        "targets": [
          "最新动态",
    ...
    "nvidia::industrial software leaders build secure, autonomous ai engineers with nvidia nemoclaw": {
      "draft_id": "auto-nvidia-industrial-software-leaders-build-secure-autonomous-ai-engineers-with-nvidia-nemoclaw",
      "company": "nvidia",
      "company_name": "NVIDIA",
      ...
      "portal_doc": "./docs/review-drafts/auto-nvidia-industrial-software-leaders-build-secure-autonomous-ai-engineers-with-nvidia-nemoclaw.md",
      "has_source_body": true,
      "company_page_writeback": {
        "targets": [
          "最新动态",
    ...
    "nvidia::why financial institutions are converging on transaction foundation models to build their own intelligence": {
      "draft_id": "auto-nvidia-why-financial-institutions-are-converging-on-transaction-foundation-models-to-build-their-own-in",
      "company": "nvidia",
      "company_name": "NVIDIA",
      "title": "Why Financial Institutions Are Converging on Transaction Foundation Models to Build Their Own Intelligence",
    ...
    "nvidia::nvidia jetson brings agentic ai to the physical world": {
      "draft_id": "auto-nvidia-nvidia-jetson-brings-agentic-ai-to-the-physical-world",
      "company": "nvidia",
      "company_name": "NVIDIA",
      "title": "NVIDIA Jetson Brings Agentic AI to the Physical World",
