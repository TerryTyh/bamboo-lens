window.BAMBOO_LENS_REVIEW_DRAFTS = {
  ...
  "summary": {
    ...
    "priority_batch": [
      ...
      {
        "draft_id": "auto-tsmc-tsmc-reports-second-quarter-eps-of-nt-27-25",
        "company": "tsmc",
        "company_name": "TSMC",
        ...
        "score": 10,
        "readiness_score": 32,
        "investment_signal_score": 30,
        "readiness_lane": "ready_for_deep_review",
        "readiness_label": "优先深读",
        "review_batch_reason": "已有较长可读正文，候选分数也足够高，适合作为下一批正式事件研判对象。",
        "promotion_blockers": [],
        "source_url": "http://pr.tsmc.com/english/news/3326",
        "portal_doc": "./docs/review-drafts/auto-tsmc-tsmc-reports-second-quarter-eps-of-nt-27-25.md",
        "has_source_body": true,
        "company_page_writeback": {
          "targets": [
            "最新动态",
  ...
  "by_key": {
    ...
    "tsmc::tsmc reports second quarter eps of nt$27.25": {
      "draft_id": "auto-tsmc-tsmc-reports-second-quarter-eps-of-nt-27-25",
      "company": "tsmc",
      "company_name": "TSMC",
      "title": "TSMC Reports Second Quarter EPS of NT$27.25",
