window.BAMBOO_LENS_COMPANY_PAGE_OVERRIDES = {
  ...
  "source_deposition_at": "2026-05-10T18:16:37",
  "companies": {
    "tsmc": {
      ...
      "sectionDeposits": {
        "financeMap": {
          "notes": [
            {
              "title": "事件沉淀｜2026 年 4 月营收 NT$4107.3 亿，环比小降但同比仍增 17.5%，高位需求进入延续验证期",
            ...
            {
              "title": "事件沉淀｜2026 年 3 月营收环比反弹 30.7%，Q1 累计同比 35.1%，先进制程需求仍处高位",
              "text": "继续跟踪 4 月、5 月、6 月营收，判断 Q2 是否能沿着管理层 US$39.0-40.2 billion 指引运行。；结合 Q2 财报验证高营收是否转化为 65.5%-67.5% 毛利率区间，而不是被海外扩产或折旧稀释。；观察 HPC/AI 需求是否继续支撑先进制程占比，尤其是 3nm、5nm 和 CoWoS 供需。"
            }
          ]
        },
        "businessMap": {
          "segments": [
            ...
            {
              "title": "事件沉淀｜2026 年 3 月营收环比反弹 30.7%，Q1 累计同比 35.1%，先进制程需求仍处高位",
              "scale": "2026-04-10｜月度营收 / 需求验证",
              "text": "业务影响主要落在先进制程、高性能计算和 AI 相关晶圆需求。月度营收无法拆分 3nm/5nm/HPC，但 Q1 财报已显示先进制程占晶圆收入 74%、HPC 占净收入 61%。因此 3 月营收的强劲反弹更像是对领先制程需求强度的高频验证，而不是独立的新业务线变化。"
            }
          ],
          "moat": [
            {
            ...
            {
              "title": "这条事件改变了什么",
              "text": "这是一条 P1 级强化事件。3 月数据说明 TSMC 的高增长不是只靠某个单月，2 月季节性回落后 3 月迅速修复，Q1 累计同比达到 35.1%。对长期跟踪而言，月度营收继续支持 AI/HPC 和先进制程需求处于高景气。"
            }
          ]
        },
        "valuationModel": {
          "currentBreakdown": [
            ...
            {
              "title": "事件沉淀｜2026 年 3 月营收环比反弹 30.7%，Q1 累计同比 35.1%，先进制程需求仍处高位",
              "text": "估值上，这条事件支持维持 TSMC 的高质量制造平台溢价：收入增长仍强，且与 Q1 高毛利率、高先进制程占比相互验证。但它不是单独加仓触发器，因为月度营收只验证收入端，不验证毛利率、capex 回报和海外扩产成本。动作上维持 A 池核心，继续等待 Q2 指引和后续月度营收确认高增长能否延续。"
            }
          ],
          "triggers": [
            {
      ...
      "depositEvents": [
        ...
        },
        {
          ...
          "date": "2026-04-10",
          "priority": "P1",
          "detailLink": "./event.html?company=tsmc&event=4&return=company&v=20260505-1"
        }
      ]
    },
    "nvidia": {
