window.BAMBOO_LENS_COMPANY_PAGE_OVERRIDES = {
  ...
  "source_event_store_at": "2026-05-14T13:35:32",
  "source_deposition_at": "2026-05-14T13:35:32",
  "companies": {
    "nvidia": {
      "source": "decision_deposition",
      "sourceEventIndex": 0,
      "sourceEventTitle": "SAP 在 Business AI Platform 集成 NVIDIA OpenShell：为企业级 AI Agent 提供隔离执行与治理控制",
      "sourceEventDate": "2026-05-12",
      "sourceEventLink": "./event.html?company=nvidia&event=0&return=company&v=20260505-1",
      "updatedAt": "2026-05-14T13:35:32",
      "latestEvent": "2026-05-12｜SAP 在 Business AI Platform 集成 NVIDIA OpenShell：为企业级 AI Agent 提供隔离执行与治理控制",
      "businessImpact": "企业 agent 真正进入财务、采购、供应链与制造等系统-of-record 后，权限边界、策略执行与审计追踪会成为落地的硬门槛。SAP 把 OpenShell 嵌入平台并用于其 agent 体系，等于把“运行时治理/隔离”作为平台能力下沉，可能降低企业采用 agentic AI 的安全顾虑，并使 NVIDIA 的软件与运行时能力在企业应用链条中更可见。真正的业务影响取决于：OpenShell 是否成为 SAP 客户的默认选择、以及是否与 NVIDIA 企业软件栈形成捆绑或增量服务收入。",
      ...
      "nextCheck": "是否出现可核验的客户落地案例（行业、业务流程、部署范围），以及 OpenShell 在 SAP 客户中的默认覆盖范围。；NVIDIA 是否在财报/电话会中给出更清晰的企业软件/agent 相关收入口径或商业化模式（订阅、捆绑、渠道分成等）。",
