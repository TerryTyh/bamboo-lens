window.BAMBOO_LENS_COMPANY_PAGE_OVERRIDES = {
  ...
  "source_deposition_at": "2026-06-08T15:33:25",
  "companies": {
    "nvidia": {
      ...
      "nextCheck": "跟踪 RTX Spark 和 DGX Station for Windows 的实际上市时间、渠道价格、客户采用和企业案例，判断端侧与本地部署是否形成真实需求。；观察 Azure GB300 / Blackwell Ultra、Foundry 上 Nemotron 与 OpenShell 的商业化口径，尤其是客户数量、推理负载和收费模式。",
          ...
          "moat": [
            {
              ...
              "text": "这是一条 P2 级平台外延强化事件。它的关键不是某台 PC 或某个模型上架，而是 NVIDIA 正在和 Microsoft 一起定义企业智能体的完整部署路径：端侧开发、本地推理、云端前沿模型、安全运行时、数据访问和行业技能被连成一体。对投资判断更重要的是，这说明 NVIDIA 平台化不再只停留在超大训练集群，而是在往企业生产级智能体工作流渗透。"
            }
          ]
        },
        "valuationModel": {
