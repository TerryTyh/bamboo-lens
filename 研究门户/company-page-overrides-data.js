window.BAMBOO_LENS_COMPANY_PAGE_OVERRIDES = {
  ...
  "source_deposition_at": "2026-07-02T13:35:03",
  "companies": {
    "wus": {
      ...
      "nextCheck": "核对人工智能芯片配套高端 PCB 项目是否在 2026H2 按期试产，并披露客户认证、良率、产能利用率或收入贡献。；跟踪昆山普江厂房扩建的投资额、产品方向、建设进度和新增折旧。",
          ...
          "rows": [
            {
              ...
              "metric": "事件证据 1",
              "value": "公司认为 AI 服务器和高速网络交换机部署为 PCB 带来结构性增长，但同行新增产能落地后，成熟技术平台的准入门槛可能被摊薄，利润空间可能受到结构性挤压。",
              "change": "2026-06-24｜产能 / AI 服务器 PCB",
              "read": "这条记录强化了沪电股份作为 AI 高端 PCB 优先样本的地位，并给出了 2026H2 试产这一可验证时间点；但新增项目和厂房扩建也提高了资本开支、折旧和产能消化要求。公司主动提示行业同质化扩产和利润挤压，说明后续不能只看 AI 需求，还必须验证毛利率、客户认证和现金流。"
            }
          ],
          "bridge": [
            {
              ...
              "text": "沪电股份在 2026 年 6 月 24 日投资者关系活动记录中表示，AI 训练、推理和商业化扩张推动 CSP 增加资本支出，并带动 AI 服务器和高速网络交换机 PCB 的结构性需求。"
            },
            {
              "key": "finance-bridge-财报-经营验证-evidence",
              "label": "第二层：哪些事实最关键",
              "text": "公司强调不会以规模和价格为导向做同质化扩张，而会把资源集中到数据通讯高附加值核心 PCB，并通过国内与泰国产能协同服务头部客户。"
            },
            {
              "key": "finance-bridge-财报-经营验证-judgment",
              "label": "第三层：它改变了什么判断",
              "text": "这条记录强化了沪电股份作为 AI 高端 PCB 优先样本的地位，并给出了 2026H2 试产这一可验证时间点；但新增项目和厂房扩建也提高了资本开支、折旧和产能消化要求。公司主动提示行业同质化扩产和利润挤压，说明后续不能只看 AI 需求，还必须验证毛利率、客户认证和现金流。"
            }
          ],
          "notes": [
            {
              ...
              "title": "财报/经营验证｜财务读法",
              "text": "原文事实：沪电股份在 2026 年 6 月 24 日投资者关系活动记录中表示，AI 训练、推理和商业化扩张推动 CSP 增加资本支出，并带动 AI 服务器和高速网络交换机 PCB 的结构性需求。；公司强调不会以规模和价格为导向做同质化扩张，而会把资源集中到数据通讯高附加值核心 PCB，并通过国内与泰国产能协同服务头部客户。；公司同时提示，同行激进扩产可能摊薄成熟技术平台的准入门槛，使行业竞争白热化并挤压利润空间。 证据：公司认为 AI 服务器和高速网络交换机部署为 PCB 带来结构性增长，但同行新增产能落地后，成熟技术平台的准入门槛可能被摊薄，利润空间可能受到结构性挤压。。读法：这条记录强化了沪电股份作为 AI 高端 PCB 优先样本的地位，并给出了 2026H2 试产这一可验证时间点；但新增项目和厂房扩建也提高了资本开支、折旧和产能消化要求。公司主动提示行业同质化扩产和利润挤压，说明后续不能只看 AI 需求，还必须验证毛利率、客户认证和现金流。 后续验证：核对人工智能芯片配套高端 PCB 项目是否在 2026H2 按期试产，并披露客户认证、良率、产能利用率或收入贡献。；跟踪昆山普江厂房扩建的投资额、产品方向、建设进度和新增折旧。；复核 2026H1/Q3 毛利率、经营现金流、存货和应收，判断扩产是否被真实订单和回款支持。"
            }
          ]
        },
        "businessMap": {
          "segments": [
            {
              ...
              "title": "财报/经营验证｜高端 AI PCB 项目预计 2026H2 试产，昆山厂房扩产同时提示行业利润挤压风险",
              "scale": "2026-06-24｜产能 / AI 服务器 PCB",
              "text": "高端 AI PCB 项目和昆山厂房扩建将增加高速运算服务器、AI 和高速网络交换机所需高附加值 PCB 的产能。国内与泰国产能协同有助于服务头部客户并分散供应链风险；原材料前置验证和多元化认证则关系到高阶产品良率与交付。但项目能否形成竞争优势，取决于技术平台、客户认证和良率，而不是单纯扩产规模。 原文要点：沪电股份在 2026 年 6 月 24 日投资者关系活动记录中表示，AI 训练、推理和商业化扩张推动 CSP 增加资本支出，并带动 AI 服务器和高速网络交换机 PCB 的结构性需求。；公司强调不会以规模和价格为导向做同质化扩张，而会把资源集中到数据通讯高附加值核心 PCB，并通过国内与泰国产能协同服务头部客户。；公司同时提示，同行激进扩产可能摊薄成熟技术平台的准入门槛，使行业竞争白热化并挤压利润空间。"
            }
          ],
          "moat": [
            {
          ...
          "currentBreakdown": [
            {
              ...
              "text": "事件提高了 2026H2 至 2027 年的产能兑现可见度，但不足以上调估值或触发追价。若试产按期、头部客户认证和产能利用率同步提升，且毛利率维持较高水平、经营现金流修复，可提高 B+ 观察置信度；若行业扩产导致价格竞争、折旧上升而现金流继续弱于利润，应降低估值容忍度。"
            }
          ],
          "scenarios": [
            {
              ...
              "title": "估值中枢上修条件",
              "text": "核对人工智能芯片配套高端 PCB 项目是否在 2026H2 按期试产，并披露客户认证、良率、产能利用率或收入贡献。"
            }
          ],
          "triggers": [
            {
              ...
              "title": "下一步验证｜财报/经营验证",
              "text": "核对人工智能芯片配套高端 PCB 项目是否在 2026H2 按期试产，并披露客户认证、良率、产能利用率或收入贡献。；跟踪昆山普江厂房扩建的投资额、产品方向、建设进度和新增折旧。；复核 2026H1/Q3 毛利率、经营现金流、存货和应收，判断扩产是否被真实订单和回款支持。"
            }
          ]
        }
      },
    ...
    "tsmc": {
      ...
      "nextCheck": "6 月营收是否继续维持 NT$400 billion 以上，并和 4-5 月一起验证 Q2 收入指引 US$39.0-40.2 billion。；Q2 财报毛利率是否落在 65.5%-67.5% 指引区间，确认收入高位没有被海外扩产、汇率或产品组合稀释。",
          ...
          "rows": [
            {
              "key": "finance-row-财报-经营验证-1",
              "metric": "事件证据 1",
              "value": "2026 年 5 月合并营收约 NT$416.98 billion。",
              "change": "2026-06-10｜月度营收 / Q2 需求验证",
              "read": "这是一条 P1 级连续性验证事件。5 月营收环比继续增长、同比重回 30% 以上，说明 Q2 第二个月仍处高景气区间；它强化了 TSMC 先进制程和 AI/HPC 需求高位延续的判断。但月度营收公告没有分业务、毛利率、现金流或客户结构，不能单独证明盈利质量继续改善，也不能替代 Q2 财报。"
            },
            {
              "key": "finance-row-财报-经营验证-2",
              "metric": "事件证据 2",
              "value": "5 月营收较 2026 年 4 月增长 1.5%，说明 4 月 NT$410.73 billion 的高位没有回落。",
              "change": "2026-06-10｜月度营收 / Q2 需求验证",
              "read": "这是一条 P1 级连续性验证事件。5 月营收环比继续增长、同比重回 30% 以上，说明 Q2 第二个月仍处高景气区间；它强化了 TSMC 先进制程和 AI/HPC 需求高位延续的判断。但月度营收公告没有分业务、毛利率、现金流或客户结构，不能单独证明盈利质量继续改善，也不能替代 Q2 财报。"
            },
            {
              ...
              "metric": "事件证据 3",
              "value": "5 月营收较 2025 年 5 月增长 30.1%，同比增速重新回到 30% 以上。",
              "change": "2026-06-10｜月度营收 / Q2 需求验证",
              "read": "这是一条 P1 级连续性验证事件。5 月营收环比继续增长、同比重回 30% 以上，说明 Q2 第二个月仍处高景气区间；它强化了 TSMC 先进制程和 AI/HPC 需求高位延续的判断。但月度营收公告没有分业务、毛利率、现金流或客户结构，不能单独证明盈利质量继续改善，也不能替代 Q2 财报。"
            }
          ],
          "bridge": [
            {
              "key": "finance-bridge-财报-经营验证-source",
              "label": "第一层：原文发生了什么｜财报/经营验证",
              "text": "TSMC 在 2026-06-10 发布 2026 年 5 月营收公告。公告口径很短，但数字足够明确：5 月合并营收约 NT$416.98 billion，较 2026 年 4 月增长 1.5%，较 2025 年 5 月增长 30.1%。"
            },
            {
              "key": "finance-bridge-财报-经营验证-evidence",
              "label": "第二层：哪些事实最关键",
              "text": "公司同时披露 2026 年 1-5 月累计营收 NT$1,961.80 billion，较 2025 年同期增长 30.0%。这说明 4 月高位营收之后，5 月没有回落，反而继续小幅上行。"
            },
            {
              "key": "finance-bridge-财报-经营验证-judgment",
              "label": "第三层：它改变了什么判断",
              "text": "这是一条 P1 级连续性验证事件。5 月营收环比继续增长、同比重回 30% 以上，说明 Q2 第二个月仍处高景气区间；它强化了 TSMC 先进制程和 AI/HPC 需求高位延续的判断。但月度营收公告没有分业务、毛利率、现金流或客户结构，不能单独证明盈利质量继续改善，也不能替代 Q2 财报。"
            }
          ],
          "notes": [
            {
              "key": "finance-note-财报-经营验证",
              "title": "财报/经营验证｜财务读法",
              "text": "原文事实：TSMC 在 2026-06-10 发布 2026 年 5 月营收公告。公告口径很短，但数字足够明确：5 月合并营收约 NT$416.98 billion，较 2026 年 4 月增长 1.5%，较 2025 年 5 月增长 30.1%。；公司同时披露 2026 年 1-5 月累计营收 NT$1,961.80 billion，较 2025 年同期增长 30.0%。这说明 4 月高位营收之后，5 月没有回落，反而继续小幅上行。；把 4 月和 5 月连起来看，TSMC 已经连续两个月维持在 NT$410 billion 以上。5 月数据本身不提供分业务、毛利率、EPS 或现金流，但它为 Q2 收入指引兑现提供了第二个月证据。 证据：2026 年 5 月合并营收约 NT$416.98 billion。；5 月营收较 2026 年 4 月增长 1.5%，说明 4 月 NT$410.73 billion 的高位没有回落。；5 月营收较 2025 年 5 月增长 30.1%，同比增速重新回到 30% 以上。。读法：这是一条 P1 级连续性验证事件。5 月营收环比继续增长、同比重回 30% 以上，说明 Q2 第二个月仍处高景气区间；它强化了 TSMC 先进制程和 AI/HPC 需求高位延续的判断。但月度营收公告没有分业务、毛利率、现金流或客户结构，不能单独证明盈利质量继续改善，也不能替代 Q2 财报。 后续验证：6 月营收是否继续维持 NT$400 billion 以上，并和 4-5 月一起验证 Q2 收入指引 US$39.0-40.2 billion。；Q2 财报毛利率是否落在 65.5%-67.5% 指引区间，确认…"
            }
          ]
        },
        "businessMap": {
          ...
          "currentBreakdown": [
            {
              "key": "valuation-current-财报-经营验证",
              "title": "财报/经营验证｜估值/动作影响",
              "text": "估值/动作上，5 月营收支持 TSMC 继续保持 A 池核心和质量溢价，但不构成新的追高信号。真正决定估值中枢的仍是 Q2 指引能否完整兑现、毛利率是否维持在 65.5%-67.5%、以及高资本开支和海外扩产是否侵蚀自由现金流。动作上维持核心跟踪，不因单月收入上行加仓；下一步用 6 月营收和 Q2 财报确认收入高位是否能转化为高质量利润。"
            }
          ],
          "scenarios": [
            {
              "key": "valuation-scenario-upside",
              "title": "估值中枢上修条件",
              "text": "6 月营收是否继续维持 NT$400 billion 以上，并和 4-5 月一起验证 Q2 收入指引 US$39.0-40.2 billion。"
            }
          ],
          "triggers": [
            {
              "key": "valuation-trigger-财报-经营验证",
              "title": "下一步验证｜财报/经营验证",
              "text": "6 月营收是否继续维持 NT$400 billion 以上，并和 4-5 月一起验证 Q2 收入指引 US$39.0-40.2 billion。；Q2 财报毛利率是否落在 65.5%-67.5% 指引区间，确认收入高位没有被海外扩产、汇率或产品组合稀释。；Q2 财报继续看先进制程占比、HPC 需求和先进封装产能口径，判断 5 月收入高位背后的结构质量。"
            }
          ]
        }
      },
      ...
      "sectionDeposits": {
        ...
        "businessMap": {
          "segments": [
            {
              "key": "business-segment-财报-经营验证",
              "title": "财报/经营验证｜SK Telecom 将于 2027 年上线首座 AI 工厂，NVIDIA 开始把韩国电信网络推成主权 AI 云底座",
              "scale": "2026-06-07｜AI 云基础设施 / 电信 AI 平台 / 主权 AI",
              "text": "业务影响主要落在 Data Center、networking、AI factory software 以及主权 AI 平台输出四条线。电信运营商原本就掌握机房、电力接入、网络和大型企业客户，如果 SK Telecom 能把这些资源转成 AI Cloud，NVIDIA 的角色就不再只是卖训练卡，而是把 DSX、MaxLPS、DSX OS 和系统方案嵌入运营商基础设施。与单纯卖给 hyperscaler 相比，这类客户一旦跑通模型，后续更可能复制到本地企业、机器人、制造和主权 AI 场景，扩展 NVIDIA 在亚洲企业 AI 与 physical AI 的需求承接层。 原文要点：原文先宣布 SK Telecom 将在韩国建设 gigawatt-scale AI Cloud，底层采用 NVIDIA DSX 全栈 AI factory 参考架构，首座 AI 工厂计划在 2027 年上线。文章重点不是单笔 GPU 采购，而是在把韩国电信运营商的网络、数据中心和企业客户基础，改造成面向训练、推理和智能体工作负载的 AI 云基础设施。；原文进一步解释这朵 AI Cloud 的定位：它不是通用云，而是专门为 AI 训练、推理和 agentic AI 设计的 GPU 云。SK Telecom 将依托自身网络、数据中心和企业基础设施，为韩国企业和行业提供 sovereign、physical 和 enterprise AI 服务，并把覆盖范围向更广泛亚洲地区扩展。；技术栈部分，文章明确点出 NVIDIA DSX 会作为架构蓝图，组合 accelerate…"
            }
          ],
          "moat": [
            {
              "key": "business-moat-财报-经营验证",
              "title": "护城河/业务主线是否变化｜财报/经营验证",
              "text": "这是一条 P1 级 AI 基础设施扩张事件。关键增量不只是 SK Telecom 新买一批 GPU，而是电信运营商开始按“国家级 AI 云 + AI factory”模式重构算力供给。对 NVIDIA 而言，这说明需求曲线正从 hyperscaler 与国家实验室继续外扩到拥有网络、机房和企业客户入口的 telco 平台，平台化叙事进一步落到可执行项目和时间表上。"
            }
          ]
        },
        "valuationModel": {
