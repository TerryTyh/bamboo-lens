window.BAMBOO_LENS_COMPANY_PAGE_OVERRIDES = {
  ...
  "source_deposition_at": "2026-07-06T22:36:36",
  "companies": {
    "nvidia": {
      "source": "decision_deposition",
      "sourceEventIndex": 0,
      "sourceEventTitle": "NVIDIA为 AI 云引入收入分成与信用支持，从卖硬件延伸到算力运营收益与风险共担",
      "sourceEventDate": "2026-07-01",
      "sourceEventLink": "./event.html?company=nvidia&event=0&return=company&v=20260505-1",
      "updatedAt": "2026-07-06T22:36:36",
      ...
      "nextCheck": "跟踪 Sharon AI 与 Firmus 的实际融资关闭、设备采购、交付节奏和上线利用率，不把项目上限当成已实现销量。；在 NVIDIA 后续财报、10-Q/10-K 与电话会中查找信用支持、保证、融资应收、合同负债或收入分成的会计披露。",
          ...
          "segments": [
            {
              ...
              "title": "财报/经营验证｜NVIDIA为 AI 云引入收入分成与信用支持，从卖硬件延伸到算力运营收益与风险共担",
              "scale": "2026-07-01｜商业模式 / AI 云 / 资本支持",
              "text": "正面影响是扩大可负担的客户范围，缩短 AI 云从订单到上线的融资周期，并把 DSX、GB300 和全栈软件嵌入新兴区域算力市场。更重要的是，NVIDIA 的收入不再只与设备交付挂钩，还与云产能实际销售挂钩。反面是信用支持可能降低初期订单的风险含金量：如果需求、定价或利用率不及预期，NVIDIA 可能同时面临客户信用和分成收入下降。 原文要点：NVIDIA 宣布一种面向 AI 云的新商业模式：合作方采购 NVIDIA 基础设施并向 AI 原生公司、企业和软件客户销售云服务，NVIDIA 除获得标准产品收入外，还对受支持产能获得云收入分成，并提供信用支持。这是从一次性硬件销售向持续、按使用量联动收益的延伸。；首批合作方已披露规模：Sharon AI 计划部署最多 4 万颗 Grace Blackwell GB300 GPU；Firmus 在印度尼西亚巴淡建设 DSX AI 工厂园区，预计扩展到 360MW 和最多 17 万颗 NVIDIA GPU。两个项目的上限合计约 21 万颗 GPU，但原文没有披露交付时间表、采购金额或最低利用率。；原文把模式的经济动因定义为：新兴 AI 客户即使给出长期承诺，也往往不足以支持昂贵算力设施融资。NVIDIA 用信用支持和经济利益绑定帮助 AI 云更快上线产能，并从未来云收入中分享回报。"
            }
          ],
          "moat": [
            {
