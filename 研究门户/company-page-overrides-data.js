window.BAMBOO_LENS_COMPANY_PAGE_OVERRIDES = {
  ...
  "source_event_store_at": "2026-05-14T15:41:18",
  "source_deposition_at": "2026-05-14T15:41:18",
  "companies": {
    "nvidia": {
      "source": "decision_deposition",
      "sourceEventIndex": 0,
      "sourceEventTitle": "Hermes Unlocks Self-Improving AI Agents, Powered by NVIDIA RTX PCs and DGX Spark",
      "sourceEventDate": "2026-05-13",
      "sourceEventLink": "./event.html?company=nvidia&event=0&return=company&v=20260505-1",
      "updatedAt": "2026-05-14T15:41:18",
      ...
      "nextCheck": "跟踪后续是否出现可核验的采用证据：Hermes/类似本地 agent 在企业/开发者侧的部署案例、活跃度或官方生态数据披露。；观察 RTX AI PC 与工作站出货/ASP/渠道反馈是否出现“agent 本地运行”驱动的结构性变化。",
      ...
      "sectionDeposits": {
        ...
        "businessMap": {
          "segments": [
            {
              "title": "业务变化｜Hermes Unlocks Self-Improving AI Agents, Powered by NVIDIA RTX PCs and DGX Spark",
              "scale": "2026-05-13｜生态/本地 Agent",
              "text": "对 NVIDIA 来说，核心影响在端侧与小型机生态而非数据中心训练：一是 RTX PC/RTX PRO 工作站可被定义为“全天候本地 agent 机器”，潜在带动高端 GPU 与整机升级；二是 DGX Spark 等小型机把 agent 负载从云端外溢到企业/开发者本地，增加软件栈与硬件耦合。整体属于“新增使用场景 + 生态绑定”的布局，需观察是否从叙事走向规模交付。"
            },
            {
              "title": "业务变化｜NVIDIA, Ineffable Intelligence Team Up to Build the Future of Reinforcement Learning Infrastructure",
              "scale": "2026-05-13｜生态/训练基础设施（强化学习）",
              "text": "从业务上看，RL/后训练工作负载若走向规模化，会把算力需求从“单次大训练”扩展到“持续生成数据与训练更新”的闭环，对 GPU、互联与系统软件的要求更系统化。NVIDIA 通过与前沿实验室共设基础设施，有助于在平台迭代时把新负载的关键瓶颈（互联、带宽、服务链路）纳入产品路线，从而巩固其系统级平台地位。"
            },
            {
              "title": "业务变化｜SAP 在 Business AI Platform 集成 NVIDIA OpenShell：为企业级 AI Agent 提供隔离执行与治理控制",
              "scale": "2026-05-12｜生态合作/企业软件",
              "text": "企业 agent 真正进入财务、采购、供应链与制造等系统-of-record 后，权限边界、策略执行与审计追踪会成为落地的硬门槛。SAP 把 OpenShell 嵌入平台并用于其 agent 体系，等于把“运行时治理/隔离”作为平台能力下沉，可能降低企业采用 agentic AI 的安全顾虑，并使 NVIDIA 的软件与运行时能力在企业应用链条中更可见。真正的业务影响取决于：OpenShell 是否成为 SAP 客户的默认选择、以及是否与 NVIDIA 企业软件栈形成捆绑或增量服务收入。"
            }
          ],
          "moat": [
            {
              "title": "判断变化｜生态/本地 Agent",
              "text": "这条信息更像“生态与需求叙事”的强化：NVIDIA 正把本地 agent 作为 RTX AI PC/小型工作站的新工作负载来推动，并通过开源 agent + 开源权重模型的组合把用户体验与 GPU/整机能力绑定。它提高了我们对“端侧 AI 叠加 agent 工作流”的中期想象空间，但短期仍缺少可量化的采用与收入验证，暂按 P3 处理。"
            },
            {
              "title": "判断变化｜生态/训练基础设施（强化学习）",
              "text": "这条合作更偏“前瞻研发/生态信号”：NVIDIA 正尝试在预训练之外，提前为强化学习与模拟环境学习等后训练范式打造可扩展的软硬件流水线，并把该方向与 Grace Blackwell、Vera Rubin 等新平台绑定。它增加了我们对“新训练范式驱动持续算力需求”的中期信心，但短期仍缺少客户规模、订单与可量化商业化节奏，因此按 P3 处理。"
            },
            {
              "title": "判断变化｜生态合作/企业软件",
              "text": "这条合作更像 NVIDIA “企业 AI/agent 栈向上延伸到应用与治理层”的一块拼图：如果 SAP 作为企业系统核心入口，把 OpenShell 作为默认运行时安全层落地在大量客户的生产工作流中，会提高 NVIDIA 在企业 agent 生态里的存在感与标准话语权；但短期内文章未给出订单、收费模式与部署规模，更多是“工程与生态协作”性质，估值影响应低于硬件供给与云厂商规模化采购等主线。"
            }
          ]
        },
        "valuationModel": {
          "currentBreakdown": [
            {
              "title": "估值/动作影响｜Hermes Unlocks Self-Improving AI Agents, Powered by NVIDIA RTX PCs and DGX Spark",
              "text": "估值/动作层面，这类生态文章本身不会立刻改变盈利预测，但会影响市场对“端侧 AI + agent 工作流”可持续性的想象空间：若后续出现可验证的采用数据（出货、活跃、企业部署案例），可能抬升对 RTX 相关增长与毛利结构的信心；反之若仅停留在宣传与社区热度，则对估值贡献有限。当前动作以维持跟踪为主，不据此单独加仓。"
            },
            {
              "title": "估值/动作影响｜NVIDIA, Ineffable Intelligence Team Up to Build the Future of Reinforcement Learning Infrastructure",
              "text": "估值/动作层面，该类合作更像“未来需求曲线”的证据点：若 RL/后训练成为主流，将延长高端算力与系统平台的景气周期，支持估值中枢维持；但在缺少可验证客户采用与预算分配前，不应据此上调短期盈利假设。当前动作以维持跟踪为主，等待后续平台发布/客户案例/产品化披露来验证方向是否从研究走向规模化部署。"
            },
            {
              "title": "估值/动作影响｜SAP 在 Business AI Platform 集成 NVIDIA OpenShell：为企业级 AI Agent 提供隔离执行与治理控制",
              "text": "对估值与动作的直接影响当前有限：缺少可量化的商业化口径（付费、席位、订阅、部署规模）。更合理的跟踪方式是把它当作“企业软件渠道与平台绑定”的信号：若后续出现 SAP 客户案例、部署规模与收费模式披露，才可能转化为对软件/服务收入可见度的上修。动作上维持跟踪，等待公司在电话会/投资者材料中对 enterprise agent、AI software attach rate 或相关收入口径的量化。"
            }
          ],
          "triggers": [
            {
              "title": "下一步验证｜生态/本地 Agent",
              "text": "跟踪后续是否出现可核验的采用证据：Hermes/类似本地 agent 在企业/开发者侧的部署案例、活跃度或官方生态数据披露。；观察 RTX AI PC 与工作站出货/ASP/渠道反馈是否出现“agent 本地运行”驱动的结构性变化。；若 DGX Spark 被持续提及，关注其目标客户、交付节奏与是否形成可复用的软件/运行时绑定（而不是一次性硬件宣传）。"
            },
            {
              "title": "下一步验证｜生态/训练基础设施（强化学习）",
              "text": "关注 NVIDIA 后续在产品/平台发布中对 RL/后训练基础设施的明确支持（软件栈、互联/带宽优化、参考架构）。；观察是否出现可核验的客户采用：Ineffable 或类似团队在公开材料中披露使用规模、集群形态或性能指标。；跟踪 Vera Rubin 平台相关披露中，是否把 RL/模拟训练作为关键用例之一，而不仅是单一的预训练/推理叙事。"
            },
            {
              "title": "下一步验证｜生态合作/企业软件",
              "text": "是否出现可核验的客户落地案例（行业、业务流程、部署范围），以及 OpenShell 在 SAP 客户中的默认覆盖范围。；NVIDIA 是否在财报/电话会中给出更清晰的企业软件/agent 相关收入口径或商业化模式（订阅、捆绑、渠道分成等）。；OpenShell 作为开源项目的演进：关键能力（策略/身份/审计）是否快速补齐，是否出现第三方生态围绕其构建。"
            }
          ]
        }
      },
    ...
    "tsmc": {
      ...
      "nextCheck": "后续季度中资本开支与折旧/现金流口径是否与“持续高强度投入”一致，尤其是自由现金流的波动与原因拆解。；TSMC Arizona 的建设/量产进度、良率爬坡与补贴条件是否兑现，是否带来结构性成本抬升或对毛利率形成拖累。",
      ...
      "sectionDeposits": {
        "financeMap": {
          "notes": [
            {
              "title": "关键财务事实｜董事会决议：2026Q1 EPS NT$22.08，核准约 US$312.84 亿资本支出并对 Arizona 注资上限 US$200 亿",
              "text": "TSMC 董事会在 2026-05-12 通过多项决议：确认 2026Q1 合并营收 NT$1,134.10 billion、净利润 NT$572.48 billion、稀释 EPS NT$22.08；通过 2026Q1 每股现金股利 NT$7.0（普通股除息日 2026-09-16、股权登记日 2026-09-22，预计 2026-10-08 发放；ADS 同步以 2026-09-16 为除息/登记日）；为长期产能与技术路线，核准资本支出拨款约 US$31,284.30 million（主要用于先进制程产能与厂房/厂务系统等）；并核准对全资子公司 TSMC Arizona 注资不超过 US$20 billion，同时包含多项关键岗位晋升。 证据：2026Q1 合并营收 NT$1,134.10 billion、净利润 NT$572.48 billion、稀释 EPS NT$22.08。；核准 2026Q1 每股现金股利 NT$7.0，并披露普通股除息日 2026-09-16、登记日 2026-09-22、发放日 2026-10-08（ADS 同步 2026-09-16）。；核准资本支出拨款约 US$31,284.30 million，用途指向先进技术产能与厂房/厂务系统。。读法：这条决议的增量不在“Q1 业绩”本身（已在季度法说与财报中被市场定价），而在资本配置与股东回报的组合：持续的高强度资本支出拨款 + 对 Arizona 的新增注资上限，意味着公司仍按“长期高需求 + 技术路线前推”的假设推进产能与全球布局；同时维持季度现金股利节奏，体现其在高投入周期中仍希望稳定回馈股东。投资上更适合用作对“高景气是否支撑高资本开支、以及海外扩产是否抬升资本回报不确定性”的跟踪节点，而不是单独触发结论反转。 后续验证：后续季度中资本开支与折旧/现金流口径是否与“持续高强度投入”一致，尤其是自由现金流的波动与原因拆解。；TSMC Arizona 的建设/量产进度、良率爬坡与补贴条件是否兑现，是否带来结构性成本抬升或对毛利率形成拖累。；先进制程与先进封装产能扩张是否仍处于高利用率区间"
            },
            {
        ...
        "businessMap": {
          "segments": [
            {
              "title": "业务变化｜董事会决议：2026Q1 EPS NT$22.08，核准约 US$312.84 亿资本支出并对 Arizona 注资上限 US$200 亿",
              "scale": "2026-05-12｜董事会/资本配置",
              "text": "资本支出拨款明确指向先进技术产能与厂房/厂务系统建设，说明公司对先进制程/先进封装相关产能扩张仍在按计划推进；对 Arizona 子公司的注资上限进一步把“美国本地制造”从项目进度推向更清晰的资金承诺口径。对业务理解的关键影响是：未来 1-2 年的供给与交付能力更依赖这些投资节奏能否顺利落地（良率、爬坡、供应链与人力），而不是仅靠需求端叙事。"
            },
            {
          ...
          "moat": [
            {
              "title": "判断变化｜董事会/资本配置",
              "text": "这条决议的增量不在“Q1 业绩”本身（已在季度法说与财报中被市场定价），而在资本配置与股东回报的组合：持续的高强度资本支出拨款 + 对 Arizona 的新增注资上限，意味着公司仍按“长期高需求 + 技术路线前推”的假设推进产能与全球布局；同时维持季度现金股利节奏，体现其在高投入周期中仍希望稳定回馈股东。投资上更适合用作对“高景气是否支撑高资本开支、以及海外扩产是否抬升资本回报不确定性”的跟踪节点，而不是单独触发结论反转。"
            },
            {
        ...
        "valuationModel": {
          "currentBreakdown": [
            {
              "title": "估值/动作影响｜董事会决议：2026Q1 EPS NT$22.08，核准约 US$312.84 亿资本支出并对 Arizona 注资上限 US$200 亿",
              "text": "估值/动作层面，核心变量是资本开支强度与海外扩产的回报质量：高投入若能继续对应高毛利/高利用率，将支撑估值中枢；若海外建厂导致成本抬升、爬坡拉长或补贴不确定，则会提高对利润率与自由现金流的折现压力。本条决议更偏“验证/校准资本开支假设”的材料：维持跟踪，等待后续季度指引、毛利率与现金流表现来决定是否需要下调对资本回报的信心或调整仓位节奏。"
            },
            {
          ...
          "triggers": [
            {
              "title": "下一步验证｜董事会/资本配置",
              "text": "后续季度中资本开支与折旧/现金流口径是否与“持续高强度投入”一致，尤其是自由现金流的波动与原因拆解。；TSMC Arizona 的建设/量产进度、良率爬坡与补贴条件是否兑现，是否带来结构性成本抬升或对毛利率形成拖累。；先进制程与先进封装产能扩张是否仍处于高利用率区间，验证高资本开支是否能转化为高质量利润。"
            },
            {
